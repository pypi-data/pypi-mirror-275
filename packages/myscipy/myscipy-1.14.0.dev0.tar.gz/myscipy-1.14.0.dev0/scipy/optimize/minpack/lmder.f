...
c
            ...
            else if (iter .gt. 2 .and. dext1 .ge. dext2) then
               lambda_tmp = dext1 ** 2 / dext2 ** 2 + lambda_min
               lambda_star = dmin1(lambda_tmp * p5, lambda_max)
            else if (iter .gt. 2 .and. dext1 .lt. dext2) then
               lambda_tmp = dext2 ** 2 / dext1 ** 2 + lambda_min
               lambda_star = dmin1(lambda_tmp * p5, lambda_max)
            end if
...
c               par = par/temp
               delta = dmin1(delta,pnorm*lambda_star)/lambda_star
               par = -par*lambda_star
               go to 260
  240       continue
