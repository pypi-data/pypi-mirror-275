...
class SubscriptionsApi:
    ...
    @validate_arguments
    def delete_subscription(self, subscription_id : Annotated[StrictStr, Field(..., description="Unique identifier of the subscription.")], delete_subscription_request : Optional[DeleteSubscriptionRequest] = None, **kwargs) -> SubscriptionExternal:  # noqa: E501
    ...
    @validate_arguments
    def resume_subscription(self, subscription_id : Annotated[StrictStr, Field(..., description="Unique identifier of the subscription.")], subscription_resume_request : SubscriptionResumeRequest, **kwargs) -> SubscriptionExternal:  # noqa: E501
    ...
    @validate_arguments
    def search_subscriptions(self, search_subscription_request : SearchSubscriptionRequest, **kwargs) -> ListResponseSubscriptionExternal:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.search_subscriptions_with_http_info(search_subscription_request, **kwargs)  # noqa: E501

    @validate_arguments
    def search_subscriptions_with_http_info(self, search_subscription_request : SearchSubscriptionRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """Search Subscriptions  # noqa: E501
