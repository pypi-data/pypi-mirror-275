...
class InvoicesApi:
    ...
    @validate_arguments
    def get_invoice(self, invoice_external_id : Annotated[StrictStr, Field(..., description="Unique identifier of the invoice.")], **kwargs) -> InvoiceExternal:  # noqa: E501
    ...
    @validate_arguments
    def get_invoice_with_http_info(self, invoice_external_id : Annotated[StrictStr, Field(..., description="Unique identifier of the invoice.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get Invoice  # noqa: E501
    ...
    @validate_arguments
    def mark_invoice_as_uncollectible(self, invoice_external_id : Annotated[StrictStr, Field(..., description="Unique identifier of the invoice.")], **kwargs) -> InvoiceExternal:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.mark_invoice_as_uncollectible_with_http_info(invoice_external_id, **kwargs)  # noqa: E501

    @validate_arguments
    def mark_invoice_as_uncollectible_with_http_info(self, invoice_external_id : Annotated[StrictStr, Field(..., description="Unique identifier of the invoice.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Mark Invoice As Uncollectible  # noqa: E501
    ...
    @validate_arguments
    def mark_invoice_as_void(self, invoice_external_id : Annotated[StrictStr, Field(..., description="Unique identifier of the invoice.")], **kwargs) -> InvoiceExternal:  # noqa: E501
    ...
    @validate_arguments
    def mark_invoice_as_void_with_http_info(self, invoice_external_id : Annotated[StrictStr, Field(..., description="Unique identifier of the invoice.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Mark Invoice As Void  # noqa: E501
    ...
    @validate_arguments
    def search_invoices(self, search_invoice_request : SearchInvoiceRequest, **kwargs) -> ListResponseInvoiceExternal:  # noqa: E501
    ...
    @validate_arguments
    def search_invoices_with_http_info(self, search_invoice_request : SearchInvoiceRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """Search Invoices  # noqa: E501
