...
class ChargeExternal(BaseModel):
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "amount_atom", "currency", "customer_id", "payment_method_id", "payment_intent_id", "invoice_id", "status", "refunded", "refunded_amount_atom", "disputed", "failure_code", "failure_message"]
