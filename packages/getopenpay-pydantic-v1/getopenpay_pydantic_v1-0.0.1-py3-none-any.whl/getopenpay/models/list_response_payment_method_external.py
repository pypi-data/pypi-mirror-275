...
class ListResponsePaymentMethodExternal(BaseModel):
    ...
    """
    data: conlist(PaymentMethodExternal) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListResponsePaymentMethodExternal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListResponsePaymentMethodExternal:
        """Create an instance of ListResponsePaymentMethodExternal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListResponsePaymentMethodExternal.parse_obj(obj)

        _obj = ListResponsePaymentMethodExternal.parse_obj({
