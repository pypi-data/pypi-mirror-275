...
class InvoiceExternal(BaseModel):
    ...
    is_deleted: Optional[StrictBool] = Field(False, description="If true, indicates that this object has been deleted")
    ...
    net_d: Optional[StrictInt] = Field(-1, description="Number of days the customer has to pay the invoice, from 0 to 365, where -1 indicates due immediately.")
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "account_id", "billing_reason", "collection_method", "customer_id", "currency", "default_payment_method_id", "description", "latest_payment_intent_id", "period_end", "period_start", "status", "paid_out_of_band", "subscription_id", "total_amount_atom", "remaining_amount_atom", "tax_amount_atom", "lines", "pre_payment_credit_notes_amount", "post_payment_credit_notes_amount", "credit_note_ids", "applied_balance_amount_atom", "due_amount_atom", "paid_amount_atom", "discounts", "total_discount_amount_atoms", "net_d", "hosted_invoice_url", "latest_payment_attempt_failure_message", "tax_processor_updated_at", "refund_ids", "refunded_amount_atom"]
