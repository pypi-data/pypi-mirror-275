...
class DeleteSubscriptionItemResponse(BaseModel):
    ...
    """
    message: Optional[StrictStr] = Field('SubscriptionItem deleted successfully.', description="Message describing result of API call.")
    subscription_item_id: StrictStr = Field(..., description="Unique identifier of the subscription_item.")
    deleted_at: Optional[datetime] = Field(...)
    drop_at_end: Optional[StrictBool] = Field(False, description="Whether or not this item will be dropped from subscription before next renewal")
