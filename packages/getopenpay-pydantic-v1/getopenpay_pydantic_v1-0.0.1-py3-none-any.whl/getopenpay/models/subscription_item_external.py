...
class SubscriptionItemExternal(BaseModel):
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "subscription_id", "pending_attachment_to_subscription_id", "price_id", "quantity", "deleted_at", "drop_at_end"]
