...
class CreateCouponRequest(BaseModel):
    ...
    is_active: Optional[StrictBool] = Field(True, description="Whether the coupon is available to be redeemed.")
    __properties = ["name", "amount_atom_off", "percent_off", "currency", "duration", "duration_in_months", "product_ids", "product_family_ids", "max_redemptions", "redeem_by", "is_active"]
