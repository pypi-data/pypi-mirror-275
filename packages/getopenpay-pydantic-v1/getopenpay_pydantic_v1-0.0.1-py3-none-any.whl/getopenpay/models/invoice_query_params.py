...
class InvoiceQueryParams(BaseModel):
    ...
    __properties = ["page_number", "page_size", "sort_key", "sort_descending", "created_at", "expand", "customer_id", "status", "subscription_id", "billing_reason", "total_amount_atom", "period_start", "period_end", "coupon_id"]
