...
class ChargeQueryParams(BaseModel):
    ...
    __properties = ["page_number", "page_size", "sort_key", "sort_descending", "created_at", "expand", "customer_id", "payment_method_id", "payment_intent_id", "invoice_id", "status", "refunded"]
