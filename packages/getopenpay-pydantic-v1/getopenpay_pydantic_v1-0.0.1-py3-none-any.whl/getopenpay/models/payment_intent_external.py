...
class PaymentIntentExternal(BaseModel):
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "amount_atom", "amount_atom_capturable", "amount_atom_received", "currency", "customer_id", "payment_method_id", "status", "invoice_id", "charge_ids", "refund_ids"]
