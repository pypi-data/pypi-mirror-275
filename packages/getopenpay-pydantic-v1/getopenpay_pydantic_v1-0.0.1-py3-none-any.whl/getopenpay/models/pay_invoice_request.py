...
class PayInvoiceRequest(BaseModel):
    ...
    paid_out_of_band: Optional[StrictBool] = Field(False, description="Boolean representing whether an invoice is paid outside of OpenPay. This will result in no charge being made. Defaults to false.")
