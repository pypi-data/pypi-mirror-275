...
class AccountExternal(BaseModel):
    ...
    branding_settings: Dict[str, Any] = Field(..., description="The branding settings associated with this account.")
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "name", "business_type", "country", "created_by_id", "branding_settings"]
