...
class CustomersApi:
    ...
    @validate_arguments
    def list_customer_payment_methods(self, customer_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the customer.")], customer_payment_method_query_params : CustomerPaymentMethodQueryParams, **kwargs) -> ListResponsePaymentMethodExternal:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListResponsePaymentMethodExternal
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def list_customer_payment_methods_with_http_info(self, customer_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the customer.")], customer_payment_method_query_params : CustomerPaymentMethodQueryParams, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListResponsePaymentMethodExternal, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def list_valid_subscriptions(self, customer_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the customer.")], list_active_sub_params : ListActiveSubParams, **kwargs) -> ActiveSubResponse:  # noqa: E501
    ...
    @validate_arguments
    def list_valid_subscriptions_with_http_info(self, customer_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the customer.")], list_active_sub_params : ListActiveSubParams, **kwargs) -> ApiResponse:  # noqa: E501
        """List Valid Subscriptions  # noqa: E501
    ...
    @validate_arguments
    def search_customers(self, search_customer_request : SearchCustomerRequest, **kwargs) -> ListResponseCustomerExternal:  # noqa: E501
    ...
    @validate_arguments
    def search_customers_with_http_info(self, search_customer_request : SearchCustomerRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """Search Customers  # noqa: E501
