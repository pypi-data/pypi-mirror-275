...
class PaymentProcessorExternal(BaseModel):
    ...
    api_keys: Dict[str, Any] = Field(..., description="These keys will allow to authenticate API requests to payment processor.")
    description: Optional[StrictStr] = Field(...)
    is_default: StrictBool = Field(..., description="Indicates whether this payment processor is default or not")
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "account_id", "processor_name", "api_keys", "description", "is_default"]
