...
class CreateSubscriptionRequest(BaseModel):
    ...
    cancel_at_end: Optional[StrictBool] = Field(False, description="Boolean indicating whether this subscription should cancel at the end of the current period.")
    ...
    __properties = ["customer_id", "payment_method_id", "selected_product_price_quantity", "total_amount_atom", "cancel_at_end", "description", "trial_end", "trial_period_days", "trial_from_price", "coupon_id", "promotion_code_id"]
