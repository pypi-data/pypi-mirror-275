...
class CreatePriceRequest(BaseModel):
    ...
    transform_quantity_divide_by: Optional[Union[StrictFloat, StrictInt]] = Field(1.0, description="This transformation will be applied on quantity before multiplying by unit_amount_atom.")
    ...
    trial_period_days: Optional[StrictInt] = Field(0, description="Number of trail days for this Price.")
