...
class CheckoutSessionLineItemExternal(BaseModel):
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "amount_subtotal_atom", "amount_total_atom", "checkout_session_id", "description", "currency", "price_id", "billing_interval", "quantity"]
