...
class CreateSubscriptionItemRequest(BaseModel):
    ...
    add_at_period_end: Optional[StrictBool] = Field(False, description="If the flag is set to True, item will be added when renewing the subscription at next billing cycle.")
    price_id: StrictStr = Field(..., description="The ID of the price.")
    quantity: Optional[StrictInt] = Field(1, description="The quantity you’d like to apply to the subscription item you’re creating.")
    proration_behavior: Optional[ProrationEnum] = None
    __properties = ["subscription_id", "add_at_period_end", "price_id", "quantity", "proration_behavior"]
