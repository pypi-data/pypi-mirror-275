...
class ProductFamilyExternal(BaseModel):
    ...
    hierarchy: Optional[StrictStr] = Field('{}', description="A JSON object representing the hierarchy within the family.")
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "name", "description", "products", "hierarchy"]
