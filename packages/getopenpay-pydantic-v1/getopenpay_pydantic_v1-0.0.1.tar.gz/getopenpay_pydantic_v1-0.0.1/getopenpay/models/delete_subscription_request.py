...
class DeleteSubscriptionRequest(BaseModel):
    ...
    prorate: Optional[StrictBool] = Field(True, description="Will generate a proration invoice_item that credits remaining unused time until the subscription period end, also creates invoice_item for un-invoiced metered usage.Setting this to false will not invoice for un-invoiced metered usage.")
    __properties = ["cancellation_details", "prorate"]
