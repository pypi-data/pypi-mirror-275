...
class SubscriptionExternal(BaseModel):
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "name", "account_id", "customer_id", "description", "status", "initial_start", "current_period_start", "current_period_end", "default_payment_method_id", "cancel_at_end", "pause_at_end", "pause_for_cycles", "billing_interval", "billing_interval_count", "contract_start", "contract_auto_renew", "subscription_items", "cancellation_details", "cancelled_at", "trial_start", "trial_end", "discount", "total_billing_cycles", "remaining_billing_cycles", "paused_at", "resumes_at"]
