...
class CheckoutSessionExternal(BaseModel):
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "account_id", "account_name", "amount_subtotal_atom", "amount_total_atom", "client_reference_id", "currency", "customer_id", "customer_email", "line_items", "mode", "payment_intent_id", "return_url", "secure_token", "status", "subscription_id", "success_url", "tax_amount_atom", "url"]
