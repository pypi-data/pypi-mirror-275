...
class InvoiceItemPublic(BaseModel):
    ...
    __properties = ["name", "quantity", "amount_atom", "currency", "invoice_item_description", "discounts", "discount_amount_atoms", "amount_atom_considering_discount_applied", "price_tiers"]
