...
class DiscountExternal(BaseModel):
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "start_date", "end_date", "coupon_id", "coupon", "customer_id", "subscription_id", "invoice_id", "invoice_item_id", "promotion_code_id"]
