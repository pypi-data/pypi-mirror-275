...
class SubscriptionQueryParams(BaseModel):
    ...
    __properties = ["page_number", "page_size", "sort_key", "sort_descending", "created_at", "expand", "customer_id", "product_id", "price_id", "status", "current_period_start", "current_period_end", "coupon_id"]
