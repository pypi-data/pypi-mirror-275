...
class CreateInvoiceRequest(BaseModel):
    ...
    description: Optional[StrictStr] = Field('Manual creation of invoice', description="Description for newly created invoice")
    discounts: Optional[Discounts] = None
    __properties = ["subscription_id", "payment_method_id", "collection_method", "description", "discounts"]
