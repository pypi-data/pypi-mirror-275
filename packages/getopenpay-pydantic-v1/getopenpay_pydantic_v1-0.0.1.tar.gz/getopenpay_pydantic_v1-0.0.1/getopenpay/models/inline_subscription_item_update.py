...
class InlineSubscriptionItemUpdate(BaseModel):
    ...
    delete: Optional[StrictBool] = Field(False, description="A flag that, if set to true, will delete the specified item immediately from subscription. drop_at_end flag cannot be used while using this behaviour")
    ...
    __properties = ["id", "delete", "add_at_period_end", "drop_at_end", "price_id", "quantity", "starts_at"]
