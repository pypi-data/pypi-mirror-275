...
class CouponExternal(BaseModel):
    ...
    __properties = ["id", "object", "created_at", "updated_at", "is_deleted", "name", "is_active", "amount_atom_off", "percent_off", "currency", "duration", "duration_in_months", "max_redemptions", "times_redeemed", "redeem_by", "products", "product_families", "promotion_codes"]
