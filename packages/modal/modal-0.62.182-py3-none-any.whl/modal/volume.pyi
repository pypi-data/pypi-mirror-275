...
class _Volume(modal.object._Object):
    ...
    @staticmethod
    def from_name(label: str, namespace=1, environment_name: typing.Union[str, None] = None, create_if_missing: bool = False, version: typing.Union[int, None] = None) -> _Volume:
        ...

    @classmethod
    def ephemeral(cls: typing.Type[_Volume], client: typing.Union[modal.client._Client, None] = None, environment_name: typing.Union[str, None] = None, version: typing.Union[int, None] = None, _heartbeat_sleep: float = 300) -> typing.AsyncContextManager[_Volume]:
        ...
    ...
    @staticmethod
    async def lookup(label: str, namespace=1, client: typing.Union[modal.client._Client, None] = None, environment_name: typing.Union[str, None] = None, create_if_missing: bool = False, version: typing.Union[int, None] = None) -> _Volume:
        ...

    @staticmethod
    async def create_deployed(deployment_name: str, namespace=1, client: typing.Union[modal.client._Client, None] = None, environment_name: typing.Union[str, None] = None, version: typing.Union[int, None] = None) -> str:
        ...
...
class Volume(modal.object.Object):
    ...
    @staticmethod
    def from_name(label: str, namespace=1, environment_name: typing.Union[str, None] = None, create_if_missing: bool = False, version: typing.Union[int, None] = None) -> Volume:
        ...

    @classmethod
    def ephemeral(cls: typing.Type[Volume], client: typing.Union[modal.client.Client, None] = None, environment_name: typing.Union[str, None] = None, version: typing.Union[int, None] = None, _heartbeat_sleep: float = 300) -> synchronicity.combined_types.AsyncAndBlockingContextManager[Volume]:
        ...
    ...
    class __lookup_spec(typing_extensions.Protocol):
        def __call__(self, label: str, namespace=1, client: typing.Union[modal.client.Client, None] = None, environment_name: typing.Union[str, None] = None, create_if_missing: bool = False, version: typing.Union[int, None] = None) -> Volume:
            ...
    ...
    class __create_deployed_spec(typing_extensions.Protocol):
        def __call__(self, deployment_name: str, namespace=1, client: typing.Union[modal.client.Client, None] = None, environment_name: typing.Union[str, None] = None, version: typing.Union[int, None] = None) -> str:
            ...
