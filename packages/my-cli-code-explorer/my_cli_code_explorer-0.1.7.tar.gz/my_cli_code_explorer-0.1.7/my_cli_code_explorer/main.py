...
def my_cli_app(
    ...
    """
    if explain:
        typer.echo("This command clones your repository, processes the files against Watsonx, and provides output with code summaries, comments, and unit test cases.")
        return
