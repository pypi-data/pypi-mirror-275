...
def add_instructions():
    ...
    st.markdown("""[Go to Pandera documentation](https://pandera.readthedocs.io/en/stable/index.html)""")
    st.markdown(
        """[Create Pandera Yaml](https://pandera.readthedocs.io/en/stable/reference/generated/pandera.io.to_yaml.html)"""
    )
    st.markdown("""Upload a raw file in the internet""")
    st.markdown(
        """Enter the URL to the Panderas schema you want to use for validation, e.g. "https://raw.githubusercontent.com/resilientinfrastructure/standards/main/panderas_schema.yml"."""
    )
    st.markdown("""### Step 3: Submit and Validate""")
    st.markdown(
    ...
    st.markdown("""[Go to Demo](https://youtu.be/9Ry_A9LgrbQ)""")
