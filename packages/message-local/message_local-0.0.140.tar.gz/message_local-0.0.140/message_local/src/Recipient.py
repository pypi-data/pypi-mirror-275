...
class Recipient:
    def __init__(self, contact_id: int = None, person_id: int = None, user_id: int = None, profile_id: int = None,
                 ...
                 first_name: str = None, name_per_lang_code_str: dict[str, str] = None) -> None:
        ...
        self.__name_per_lang_code_str = name_per_lang_code_str or {}
    ...
    def get_first_name_in_lang_code(self, lang_code: LangCode = None) -> str:
        ...
        name = self.__name_per_lang_code_str.get(lang_code.value) or self.get_first_name()
        return name
    ...
    def to_dict(self):
        init_args = ("contact_id", "person_id", "user_id", "profile_id", "telephone_number",
                     "email_address_str", "preferred_lang_code_str", "first_name", "name_per_lang_code_str")
