...
class MessageTemplates(GenericCRUDML, metaclass=MetaLogger, object=object_message):
    ...
    def get_textblocks_and_attributes_by_form_id(self, form_id: int) -> list[dict]:
        ...
        return self.convert_multi_to_dict(self.cursor.fetchall(), select_clause_value="*")
...
"""  # noqa
        ...
        return self.convert_multi_to_dict(self.cursor.fetchall(), select_clause_value=columns)
