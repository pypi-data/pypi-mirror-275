    ...
    def evaluate(
        ...
        *,
        ...
        Args:
            ...
            predictions (array-like, optional): The predicted target values. Default is None.
            ...
            extra_metrics (list, optional): Additional metrics to compute. Default is None.
            ...
            model_config (dict, optional): Configuration for the model. Default is None.
            baseline_config (dict, optional): Configuration for the baseline model. Default is None.
            inference_params (dict, optional): Parameters for inference. Default is None.
