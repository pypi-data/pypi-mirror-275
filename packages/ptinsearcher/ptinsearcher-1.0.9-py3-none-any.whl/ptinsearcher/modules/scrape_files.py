...
class FileScraper:
    ...
    def _scrape_file(self, path_to_local_file: str, is_readable, ptjsonlib, args, extract_types: dict) -> dict:
        ...
        result_data = {"url": path_to_local_file.rsplit("/")[-1], "metadata": None, "emails": None, "phone_numbers": None, "ip_addresses": None, "abs_urls": None, "internal_urls": None, "internal_urls_with_parameters": None, "external_urls": None, "insecure_sources": set(), "subdomains": None, "forms": None, "comments": None}
