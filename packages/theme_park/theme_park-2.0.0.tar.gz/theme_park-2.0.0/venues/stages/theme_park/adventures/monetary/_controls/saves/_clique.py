...
import theme_park.mixes.procedure as procedure
#
#
import click
import rich
...
def monetary_saves_clique ():
	...
	'''
		itinerary:
			[ ] theme_park_1 adventures monetary saves export --version 2
	...
	'''
		theme_park_1 adventures monetary saves import --version 2 --drop
	'''
