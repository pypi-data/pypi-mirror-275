...
class FCN32s(nn.Module):
    def __init__(self, num_classes=21):
        ...
        self.upscore = nn.Sequential(
            ...
            nn.ConvTranspose2d(num_classes, num_classes, 4, 2, padding=1, output_padding=0, bias=False),
            nn.ConvTranspose2d(num_classes, num_classes, 32, 16, padding=8, output_padding=0, bias=False)
        )
...
if __name__ == "__main__":
    ...
    # fcn_model = FCN8(num_classes=num_classes)
    fcn_model = MobileFCN1(num_classes=num_classes)
