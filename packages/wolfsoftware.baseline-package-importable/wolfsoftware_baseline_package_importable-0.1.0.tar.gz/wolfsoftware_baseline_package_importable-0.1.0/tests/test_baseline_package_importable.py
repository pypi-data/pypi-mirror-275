"""
This test module provides unit tests for the Baseline Package module using pytest.
...
from wolfsoftware.baseline_package_importable import raise_exception, say_hello, ExampleCustomError


def test_version() -> None:
    """
    Test to ensure the version of the Baseline Package is set and not 'unknown'.
    ...
    try:
        version = importlib.metadata.version('wolfsoftware.baseline_package_importable')
