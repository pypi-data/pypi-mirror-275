...
class CameraSource(Protocol):
    ...
    async def update_prebuffering_state(
        self, container: PrebufferContainer, state: Literal[False]
    ) -> None: ...
    @overload
    async def update_prebuffering_state(
        self, container: PrebufferContainer, state: Literal[True], url: str
    ) -> None: ...
    async def update_prebuffering_state(
        self, container: PrebufferContainer, state: bool, url: Optional[str] = None
    ) -> None: ...
