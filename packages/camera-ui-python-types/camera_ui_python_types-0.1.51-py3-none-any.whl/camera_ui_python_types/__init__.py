...
PrebufferConfig = Union[PrebufferStateTrue, PrebufferStateFalse]
...
class CameraSource(Protocol):
    ...
    async def update_prebuffering_state(
        self, container: PrebufferContainer, state: PrebufferConfig
    ) -> None: ...
    def get_prebuffering_state(self, container: PrebufferContainer) -> PrebufferConfig: ...
    def on_prebuffering(self, container: PrebufferContainer) -> Observable[PrebufferConfig]: ...
...
CameraRemovedCallback = Union[Callable[[str], None], Callable[[str], Coroutine[None, None, None]]]
