...
class V1ListVolumeRequest(BaseModel):
    """
    V1ListVolumeRequest
    """
    ...
    __properties: ClassVar[List[str]] = ["requestId", "userId", "appId", "workerId"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of V1ListVolumeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of V1ListVolumeRequest from a dict"""
        if obj is None:
            return None
