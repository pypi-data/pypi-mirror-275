...
class V1ListVolumeResponse(BaseModel):
    """
    V1ListVolumeResponse
    """
    request_id: StrictStr = Field(alias="requestId")
    volumes: Optional[List[V1Volume]] = None
    __properties: ClassVar[List[str]] = ["requestId", "volumes"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of V1ListVolumeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of V1ListVolumeResponse from a dict"""
        if obj is None:
            return None
