...
class V1SetupVolumesVolume(BaseModel):
    """
    V1SetupVolumesVolume
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of V1SetupVolumesVolume from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of V1SetupVolumesVolume from a dict"""
        if obj is None:
            return None
