...
class V1SyncVolumeResponse(BaseModel):
    """
    V1SyncVolumeResponse
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of V1SyncVolumeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of V1SyncVolumeResponse from a dict"""
        if obj is None:
            return None
