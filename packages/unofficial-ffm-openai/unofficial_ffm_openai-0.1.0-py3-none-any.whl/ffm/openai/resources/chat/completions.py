...
#     ffmOpenAI = FfmOpenAI(api_url="https://api-ams.twcc.ai/api",
#                           api_key="321c5991-d596-4837-9027-58de9e6c4a65")
#     completions = Completions(ffmOpenAI) 
#     response = completions.create(model="ffm-mistral-7b-32k-instruct",
#         messages=[
