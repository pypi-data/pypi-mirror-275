...
from proof_of_train.model_metadata import ModelMetadata
...
class ProofOfTrain:
    def __init__(self, rpc_url, public_key, private_key):
        """
        Initialize the ProofOfTrain object.
    ...
    def submit_proof(
        self, model_id: str, metadata: ModelMetadata, gas: int = 500000, gas_price: int = 50, wait_for_confirmation: bool = False
    ) -> Union[str, TxReceipt]:
        """
        ...
        :param wait_for_confirmation: Whether to wait for the transaction to be confirmed (default: True).
        :return: The transaction hash if wait_for_confirmation is False, otherwise the transaction receipt.
        """
    ...
    def get_proof(self, model_id: str) -> ModelMetadata | None:
        """
