...
class GoogleContacts(GenericCRUD, metaclass=MetaLogger,
    ...
    @staticmethod
    def __insert_link_contact_persons(contact_dict: dict, contact_id: int) -> int:
        ...
        contact_person_id = contact_person_result_dict.get("contact_person_id")

        return contact_person_id

    @staticmethod
    def __insert_link_contact_email_addresses(contact_dict: dict, contact_id: int) -> None:
    ...
    @staticmethod
    def __insert_link_contact_phones(contact_dict: dict, contact_id: int):
    ...
    @staticmethod
    def __insert_contact_profiles(contact_dict: dict, contact_id: int) -> dict:
