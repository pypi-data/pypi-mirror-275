...
class Customer(_message.Message):
    __slots__ = ["kind", "customerAgreementMRIDs", "numEndDevices"]
    ...
    numEndDevices: int
    def __init__(self, kind: _Optional[_Union[_CustomerKind_pb2.CustomerKind, str]] = ..., customerAgreementMRIDs: _Optional[_Iterable[str]] = ..., numEndDevices: _Optional[int] = ..., **kwargs) -> None: ...
