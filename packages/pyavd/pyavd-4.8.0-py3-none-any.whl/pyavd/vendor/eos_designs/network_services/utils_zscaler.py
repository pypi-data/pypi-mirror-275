...
from pyavd.vendor.cv_client.client import CVClient
from pyavd.vendor.cv_client.workflows.models import CVDevice
from pyavd.vendor.cv_client.workflows.verify_devices_on_cv import verify_devices_in_cloudvision_inventory
...
if TYPE_CHECKING:
    from pyavd.vendor.cv_client.api.arista.swg.v1 import Location, VpnEndpoint
