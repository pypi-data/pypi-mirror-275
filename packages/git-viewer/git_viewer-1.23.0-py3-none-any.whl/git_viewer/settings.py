...
settings = {
	...
	"log-view.commit-number-enable" : ("app.LogView.commit_number_enable", bool, _("git-viewer counts the commits in the log view starting at the top. If this option is enabled the number of each commit is displayed on the right side of the line in the log view. %log-view.commit-number-pattern% specifies how the number is formatted.")),
