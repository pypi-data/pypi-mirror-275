...
@LastEditTime: 2024-05-28 17:42:36
...
class RedisExHelper:
    ...
    @classmethod
    def init(self, config_dict=None, decode_responses=True, go_heavy_connection=share_config.get_value("go_heavy_connection", False)):
        """
