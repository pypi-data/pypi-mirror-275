...
# TODO: refactor, move data to json data file or sth
class Database:
    def __init__(self):
        self.molecules = [
            "CO2",
    ...
    def call_var(self, name):
        ...
        if self.var == self.molecules[0]:
            ...
            print(
                "\n\nERROR: ",
                self.var,
                " not found. It either needs to be parametrized",
            )
            print(
                "                  ... or the element/molecule does not exist."
            )
            sys.exit(10)
...
def main() -> None:
    ...
    print(
        " |   - State your temperatures and pressures separated by commas     |"
    )
    print(
        " |     This script will create all combinations of your parameters   |"
    )
    print(
        " |     For single temperature/pressure, simply write the number      |"
    )
    print(
        " |                                                                   |"
    )
    ...
    print(
        " |   Calculates CO2 chemical potential for 150 K - 1,2,3 bar         |"
    )
    print(
        " |                                         160 K - 1,2,3 bar         |"
    )
    ...
    for i in temperature:
        ...
        for j in pressure:
            ...
            free_energy = zpve + chempot_analytical
            print(
                "\u0394\u03BC(0 \u2192 T) at",
                i,
                "K,",
                j,
                "bar :",
                f"{round(chempot_analytical, 3):.3f}",
                " eV,  G :",
                f"{round(free_energy, 3):.3f}",
                " eV",
            )
    print("")
    if max(temperature) > 1000:
        ...
        print(
            "           Values between 1000K and 1100K are still acceptable."
        )
