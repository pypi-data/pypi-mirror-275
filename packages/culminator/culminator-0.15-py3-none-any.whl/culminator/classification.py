...
X, y, parameters, predictions, label_map, mean, std = classification("Drug Prescriptions.csv")

input_data = np.array([[48,"M","HIGH","NORMAL",10.446],
                       [52,"M","NORMAL","HIGH",9.894],
                       [23,"F","HIGH","HIGH",25.355]])
input_predictions = predict_values_classification(input_data, "Drug Prescriptions.csv", mean, std, parameters, label_map)