...
def get_lang(message: str, i: int, delim: str) -> str:
    """
    ...
    # delimiter and the newline
        ...
        lang = message[end_delim:newline_pos].strip()
        print('lang =', lang)
    ...
    if not re.compile(r'[a-zA-Z0-9_-]{1,32}').fullmatch(lang):
        print('not re.compile(r\'[a-zA-Z0-9_-]{1,32}\').fullmatch(lang)')
        return ''
