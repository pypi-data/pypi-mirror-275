        ...
        for stig_file in stig_files:
            ...
            for stig in checklist.stigs:
                for vuln in stig.vulns:
                    ...
                    yield from self.process_vulnerabilities(checklist, vuln, stig)

    def process_vulnerabilities(self, checklist: Checklist, vuln: Vuln, stig: STIG) -> Iterator[IntegrationFinding]:
        """
        ...
        for asset in checklist.assets:
            ...
            yield self.create_integration_finding(asset_identifier, vuln, stig)

    def create_integration_finding(self, asset_identifier: str, vuln: Vuln, stig: STIG) -> IntegrationFinding:
        """
        ...
        due_date_map = {
            ...
            regscale_models.IssueSeverity.Low: date_str(days_from_today(394)),
        }
