...
class CRS:
    ...
    def _parse(self, string: str) -> osr.SpatialReference:
        if ':' in string:
    ...
    def _from_wkt(self, string: str) -> osr.SpatialReference:
        return osr.SpatialReference(string)

    def _from_file(self, fpath: str) -> osr.SpatialReference:
        ds, lyr = None, None
    ...
    def _from_auth(self, string: str) -> osr.SpatialReference:
