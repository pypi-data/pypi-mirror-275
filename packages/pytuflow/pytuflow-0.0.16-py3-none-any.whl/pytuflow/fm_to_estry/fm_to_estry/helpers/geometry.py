...
class Point:
    ...
    def to_wkt(self) -> str:
        """
        Returns a WKT string of the point.
    ...
    def from_wkt(wkt: str) -> 'Point':
        """
        Creates a Point object from a WKT string.
...
class Line:
    ...
    def from_wkt(wkt: str) -> 'Line':
        """
        Creates a Line object from a WKT string.
    ...
    def to_wkt(self) -> str:
        """
        Returns a WKT string of the line.
    ...
    def mid_point(self) -> Point:
        """
        Returns the mid-point of the polyline.
    ...
    def segment_index(self, distance: float) -> int:
        """
        Returns the segment index at a point along the line.
    ...
    def angle(self, segment_index: int) -> float:
        """
        Returns the angle of the segment at segment index.
