...
from tmf.tuflow_model_files.dataclasses.scope import *
...
def test_event_variable():
    scope = Scope('EVENT VARIABLE', '~ARI~')
    assert isinstance(scope, EventVariableScope)
