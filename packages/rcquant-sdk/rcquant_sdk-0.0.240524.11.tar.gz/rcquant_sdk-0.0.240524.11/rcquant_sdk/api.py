...
def fin_read_day_list(instrument_id: str, start_date: int = 0, end_date: int = 99999999, period: str = 'day'):
    '''
    获取day数据
    :param instrument_id:合约编码
    :param start_date 开始日期
    ...
    return FinClient.instance().market_handle().fin_read_day_list(FinPersistReadParamData(
        instrument_id=instrument_id, period=period, start_date=start_date, end_date=end_date))
...
def fin_read_ohlc_list(instrument_id: str, start_date: int = 0, end_date: int = 99999999, period: str = '1T'):
    '''
    获取ohlc数据
    :param instrument_id:合约编码
    :param start_date 开始日期
...
def fin_read_tick_list(instrument_id: str, start_date: int = 0, end_date: int = 99999999, period: str = 'tick'):
    '''
    获取basetick数据
    :param instrument_id:合约编码
...
def fin_delete_list(instrument_id: str, start_date: int, end_date: int, period: str):
    '''
    获取数据
    :param instrument_id:合约编码
    :param start_date 起始日期
