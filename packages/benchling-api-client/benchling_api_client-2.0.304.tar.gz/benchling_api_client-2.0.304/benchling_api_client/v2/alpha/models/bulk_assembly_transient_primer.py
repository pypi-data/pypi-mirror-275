...
from ..models.bulk_assembly_transient_primer_type import BulkAssemblyTransientPrimerType
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkAssemblyTransientPrimer")


@attr.s(auto_attribs=True, repr=False)
class BulkAssemblyTransientPrimer:
    """  """

    _bases: Union[Unset, str] = UNSET
    _binding_position: Union[Unset, str] = UNSET
    _type: Union[Unset, BulkAssemblyTransientPrimerType] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkAssemblyTransientPrimer({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, BulkAssemblyTransientPrimerType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = BulkAssemblyTransientPrimerType(_type)
                except ValueError:
                    type = BulkAssemblyTransientPrimerType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, BulkAssemblyTransientPrimerType], UNSET)

        bulk_assembly_transient_primer = cls(
            bases=bases,
            binding_position=binding_position,
            type=type,
        )

        return bulk_assembly_transient_primer
    ...
    @property
    def type(self) -> BulkAssemblyTransientPrimerType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: BulkAssemblyTransientPrimerType) -> None:
        self._type = value
