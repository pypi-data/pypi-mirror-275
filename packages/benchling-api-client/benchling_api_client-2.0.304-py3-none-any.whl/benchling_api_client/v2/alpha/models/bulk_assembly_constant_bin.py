...
from ..models.bulk_assembly_constant_bin_bin_type import BulkAssemblyConstantBinBinType
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkAssemblyConstantBin")


@attr.s(auto_attribs=True, repr=False)
class BulkAssemblyConstantBin:
    """  """

    _bin_type: Union[Unset, BulkAssemblyConstantBinBinType] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkAssemblyConstantBin({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_bin_type() -> Union[Unset, BulkAssemblyConstantBinBinType]:
            bin_type = UNSET
            _bin_type = d.pop("binType")
            if _bin_type is not None and _bin_type is not UNSET:
                try:
                    bin_type = BulkAssemblyConstantBinBinType(_bin_type)
                except ValueError:
                    bin_type = BulkAssemblyConstantBinBinType.of_unknown(_bin_type)
        ...
        try:
            ...
            if strict:
                raise
            bin_type = cast(Union[Unset, BulkAssemblyConstantBinBinType], UNSET)
        ...
        bulk_assembly_constant_bin = cls(
            bin_type=bin_type,
            id=id,
            name=name,
            residues=residues,
        ...
        return bulk_assembly_constant_bin

    @property
    def bin_type(self) -> BulkAssemblyConstantBinBinType:
        if isinstance(self._bin_type, Unset):
            raise NotPresentError(self, "bin_type")
        return self._bin_type

    @bin_type.setter
    def bin_type(self, value: BulkAssemblyConstantBinBinType) -> None:
