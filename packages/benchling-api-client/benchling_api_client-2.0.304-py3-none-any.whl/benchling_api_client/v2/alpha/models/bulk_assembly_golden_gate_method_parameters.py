...
from ..models.bulk_assembly_golden_gate_method_parameters_fragment_production_method import (
    BulkAssemblyGoldenGateMethodParametersFragmentProductionMethod,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkAssemblyGoldenGateMethodParameters")


@attr.s(auto_attribs=True, repr=False)
class BulkAssemblyGoldenGateMethodParameters:
    """  """

    _fragment_production_method: Union[
        Unset, BulkAssemblyGoldenGateMethodParametersFragmentProductionMethod
    ] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkAssemblyGoldenGateMethodParameters({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_fragment_production_method() -> Union[
            ...
            if _fragment_production_method is not None and _fragment_production_method is not UNSET:
                try:
                    ...
                    fragment_production_method = (
                        BulkAssemblyGoldenGateMethodParametersFragmentProductionMethod.of_unknown(
                            _fragment_production_method
                        )
                    )
        ...
        try:
            ...
            fragment_production_method = cast(
                Union[Unset, BulkAssemblyGoldenGateMethodParametersFragmentProductionMethod], UNSET
            )
        ...
        bulk_assembly_golden_gate_method_parameters = cls(
        ...
        return bulk_assembly_golden_gate_method_parameters

    @property
    def fragment_production_method(self) -> BulkAssemblyGoldenGateMethodParametersFragmentProductionMethod:
    ...
    def fragment_production_method(
        self, value: BulkAssemblyGoldenGateMethodParametersFragmentProductionMethod
    ) -> None:
