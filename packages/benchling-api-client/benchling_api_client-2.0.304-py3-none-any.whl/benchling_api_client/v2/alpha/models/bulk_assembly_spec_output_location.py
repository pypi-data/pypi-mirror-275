...
T = TypeVar("T", bound="BulkAssemblySpecOutputLocation")


@attr.s(auto_attribs=True, repr=False)
class BulkAssemblySpecOutputLocation:
    """  """
    ...
    def __repr__(self):
        ...
        return "BulkAssemblySpecOutputLocation({})".format(", ".join(fields))
