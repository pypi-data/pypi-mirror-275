...
from ..models.bulk_assembly_created_primer import BulkAssemblyCreatedPrimer
...
from ..models.bulk_assembly_transient_primer import BulkAssemblyTransientPrimer
from ..types import UNSET, Unset

T = TypeVar("T", bound="FinalizedBulkAssemblyConstructs")


@attr.s(auto_attribs=True, repr=False)
class FinalizedBulkAssemblyConstructs:
    """  """

    _construct_fragment_ids: Union[Unset, List[str]] = UNSET
    _construct_primers: Union[
        Unset, List[Union[BulkAssemblyCreatedPrimer, BulkAssemblyTransientPrimer, UnknownType]]
    ] = UNSET
    _output_polymer: Union[
    ...
    def __repr__(self):
        ...
        return "FinalizedBulkAssemblyConstructs({})".format(", ".join(fields))
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self._construct_primers, Unset):
            ...
            for construct_primers_item_data in self._construct_primers:
                ...
                elif isinstance(construct_primers_item_data, BulkAssemblyCreatedPrimer):
        ...
        elif isinstance(self._output_polymer, BulkAssemblySequenceReference):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_construct_primers() -> Union[
            ...
            for construct_primers_item_data in _construct_primers or []:
                ...
                def _parse_construct_primers_item(
                ...
                ) -> Union[BulkAssemblyCreatedPrimer, BulkAssemblyTransientPrimer, UnknownType]:
                    construct_primers_item: Union[
                        BulkAssemblyCreatedPrimer, BulkAssemblyTransientPrimer, UnknownType
                    ]
                    discriminator_value: str = cast(str, data.get("type"))
                    if discriminator_value is not None:
                        if discriminator_value == "BULK_ASSEMBLY_CREATED_PRIMER":
                            construct_primers_item = BulkAssemblyCreatedPrimer.from_dict(data, strict=False)

                            return construct_primers_item
                        if discriminator_value == "BULK_ASSEMBLY_TRANSIENT_PRIMER":
                            construct_primers_item = BulkAssemblyTransientPrimer.from_dict(data, strict=False)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        construct_primers_item = BulkAssemblyCreatedPrimer.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        construct_primers_item = BulkAssemblyTransientPrimer.from_dict(data, strict=True)
        ...
        def get_output_polymer() -> Union[
            ...
            if not isinstance(_output_polymer, Unset):
                ...
                if discriminator == "AA_SEQUENCE":
                    output_polymer = BulkAssemblyProteinReference.from_dict(_output_polymer)
                elif discriminator == "NUCLEOTIDE_SEQUENCE":
                    output_polymer = BulkAssemblySequenceReference.from_dict(_output_polymer)
                else:
    ...
    def construct_primers(
        self,
    ) -> List[Union[BulkAssemblyCreatedPrimer, BulkAssemblyTransientPrimer, UnknownType]]:
    ...
    def construct_primers(
        self, value: List[Union[BulkAssemblyCreatedPrimer, BulkAssemblyTransientPrimer, UnknownType]]
    ) -> None:
    ...
    def output_polymer(
        self,
    ) -> Union[BulkAssemblySequenceReference, BulkAssemblyProteinReference, UnknownType]:
        if isinstance(self._output_polymer, Unset):
