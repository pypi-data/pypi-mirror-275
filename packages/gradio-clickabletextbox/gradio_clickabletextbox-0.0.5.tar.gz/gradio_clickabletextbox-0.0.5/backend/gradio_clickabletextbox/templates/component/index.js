...
class Fn extends rn {
  constructor(e) {
    super(), vn(this, e, Hn, Vn, pn, { show_label: 0, info: 1 });
  }
}
const {
  SvelteComponent: Zn,
...
function Ci(l, e, t) {
  ...
  let { value: i = "" } = e, { value_is_output: s = !1 } = e, { lines: f = 1 } = e, { placeholder: a = "Type here..." } = e, { label: r } = e, { info: o = void 0 } = e, { disabled: u = !1 } = e, { show_label: _ = !0 } = e, { container: c = !0 } = e, { max_lines: m } = e, { prompts: v = [] } = e, { suffixes: L = [] } = e, { rtl: w = !1 } = e, { autofocus: V = !1 } = e, { text_align: b = void 0 } = e, { autoscroll: h = !0 } = e, p, T = !1, k, N = 0, B = !1, P = !1, Y = !P && (v.length > 0 || L.length > 0);
  const I = bi();
  mi(() => {
...
class Ei extends Li {
  constructor(e) {
    super(), Vi(this, e, zi, Si, Fi, { margin: 0 });
  }
}
const {
  SvelteComponent: Ti,
...
function ts(l, e, t) {
  ...
  this && this.__awaiter;
  const f = Ii();
  let { i18n: a } = e, { eta: r = null } = e, { queue_position: o } = e, { queue_size: u } = e, { status: _ } = e, { scroll_to_output: c = !1 } = e, { timer: m = !0 } = e, { show_progress: v = "full" } = e, { message: L = null } = e, { progress: w = null } = e, { variant: V = "default" } = e, { loading_text: b = "Loading..." } = e, { absolute: h = !0 } = e, { translucent: p = !1 } = e, { border: T = !1 } = e, { autoscroll: k } = e, N, B = !1, P = 0, Y = 0, I = null, ie = null, ge = 0, W = null, se, K = null, we = !0;
  const Te = () => {
