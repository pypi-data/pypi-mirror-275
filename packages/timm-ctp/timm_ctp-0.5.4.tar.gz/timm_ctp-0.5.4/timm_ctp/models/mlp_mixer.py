...
default_cfgs = dict(
    ...
    mixer_b16_224_miil_in21k=_cfg(
        url='https://miil-public-eu.oss-eu-central-1.aliyuncs.com/model-zoo/ImageNet_21K_P/models/timm_ctp/mixer_b16_224_miil_in21k.pth',
        mean=(0, 0, 0), std=(1, 1, 1), crop_pct=0.875, interpolation='bilinear', num_classes=11221,
    ),
    mixer_b16_224_miil=_cfg(
        url='https://miil-public-eu.oss-eu-central-1.aliyuncs.com/model-zoo/ImageNet_21K_P/models/timm_ctp/mixer_b16_224_miil.pth',
...
def checkpoint_filter_fn(state_dict, model):
    ...
    if 'patch_embed.proj.weight' in state_dict:
        # Remap FB ResMlp models -> timm_ctp
        out_dict = {}
