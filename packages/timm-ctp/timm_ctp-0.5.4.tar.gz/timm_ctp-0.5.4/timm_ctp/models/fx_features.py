...
# NOTE: By default, any modules from timm_ctp.models.layers that we want to treat as leaf modules go here
# BUT modules from timm_ctp.models should use the registration mechanism below
_leaf_modules = {
...
def register_notrace_module(module: nn.Module):
    """
    Any module not under timm_ctp.models.layers should get this decorator if we don't want to trace through it.
    """
