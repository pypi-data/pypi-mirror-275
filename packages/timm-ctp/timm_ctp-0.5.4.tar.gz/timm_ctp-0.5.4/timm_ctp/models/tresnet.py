...
default_cfgs = {
    'tresnet_m': _cfg(
        url='https://miil-public-eu.oss-eu-central-1.aliyuncs.com/model-zoo/ImageNet_21K_P/models/timm_ctp/tresnet_m_1k_miil_83_1.pth'),
    'tresnet_m_miil_in21k': _cfg(
        url='https://miil-public-eu.oss-eu-central-1.aliyuncs.com/model-zoo/ImageNet_21K_P/models/timm_ctp/tresnet_m_miil_in21k.pth', num_classes=11221),
    'tresnet_l': _cfg(
