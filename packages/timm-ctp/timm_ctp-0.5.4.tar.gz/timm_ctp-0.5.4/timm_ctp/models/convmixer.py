...
from timm_ctp.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from timm_ctp.models.registry import register_model
...
default_cfgs = {
    'convmixer_1536_20': _cfg(url='https://github.com/tmp-iclr/convmixer/releases/download/timm_ctp-v1.0/convmixer_1536_20_ks9_p7.pth.tar'),
    'convmixer_768_32': _cfg(url='https://github.com/tmp-iclr/convmixer/releases/download/timm_ctp-v1.0/convmixer_768_32_ks7_p7_relu.pth.tar'),
    'convmixer_1024_20_ks9_p14': _cfg(url='https://github.com/tmp-iclr/convmixer/releases/download/timm_ctp-v1.0/convmixer_1024_20_ks9_p14.pth.tar')
}
