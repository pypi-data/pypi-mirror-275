...
at https://github.com/google-research/big_transfer to match timm_ctp interfaces. The BiT weights have
...
from timm_ctp.data import IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
