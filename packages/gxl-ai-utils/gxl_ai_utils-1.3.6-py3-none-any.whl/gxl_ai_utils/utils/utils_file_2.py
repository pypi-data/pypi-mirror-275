...
def do_print_param_num_all(model):
    from .utils_file import logging_print
    param_num = 0
    for param in model.parameters():
        param_num += param.numel()
    param_num = param_num / 1024 / 1024
    logging_print('param num: ', param_num, "MB")

def do_print_param_num_trained(model):
    from .utils_file import logging_print
    param_num = 0
    for param in model.parameters():
...
def do_print_param_num_untrained(model):
    from .utils_file import logging_print
    param_num = 0
    for param in model.parameters():
