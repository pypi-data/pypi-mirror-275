...
def isPowerOfFive(n):
    return n > 0 and 1953125 % n == 0

def isPowerOfSix(n):
    return n > 0 and 1.0 / n == 1.0 / int(1.0 / n)

def isPowerOfSeven(n):
    return n > 0 and 4782969 % n == 0

def isPowerOfEight(n):
    return n > 0 and (n & (n - 1)) == 0 and n % 7 == 1 

def isPowerOfNine(n):
    return n > 0 and 387420489 % n == 0

def isPowerOfTen(n):
    return n > 0 and 1000000000 % n == 0
