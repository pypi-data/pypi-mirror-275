...
'''
	from verses.frontiers.adventures_trends.monetary.DB.verses_inventory.foods.document.insert import insert_food
	insert_food ({
		"FDC_ID": "",
		"affiliates": [],
...
from verses.besties.food_USDA.nature_v2._ops.retrieve import retrieve_parsed_USDA_food
...
def insert_food (packet):
	...
	try:
		...
		food_collection = verses_inventory_DB ["food"]
