from comment_inspect.parsers import python_parser
from comment_inspect.parsers import js_parser
from comment_inspect.parsers import c_parser
from comment_inspect.parsers import common
import sys
...
def extract_comments(filename: str, mime: Optional[str] = None) -> List[common.Comment]:
...
def extract_comments_from_str(code: str, mime: Optional[str] = None
                              ) -> List[common.Comment]:
    ...
    comments = extract_comments(tmp_file_path, mime)
