...
class StepGenerator:
    ...
    def _make_endspacer(
        ...
        t_ft = np.arctan2(points_front_top[:, 1], points_front_top[:, 0])
        t_fb = np.arctan2(points_front_bottom[:, 1], points_front_bottom[:, 0])
        t_bt = np.arctan2(points_back_outer[:, 1], points_back_outer[:, 0])
        t_bb = np.arctan2(points_back_inner[:, 1], points_back_inner[:, 0])
