...
def getTpSdkConfig():
    try:
        headers = {
            ...
            "Authorization": f"token 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",
...
def updateBin(rootDir):
    ...
    asset_url, asset_md5, version = getTpSdkConfig()
    if version:
        getOssResource(rootDir, asset_url, asset_md5, "skymedia.zip.py")
