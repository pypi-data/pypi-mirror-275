...
class Vault(BaseModel):
    def __init__(
        ...
        """
        Initializes a new instance of the Vault class, which represents a vault storing sensitive user data.
...
class SingleVault(Vault):
    def __init__(
        ...
        """
        Initializes a new instance of the SingleVault class, which extends Vault by including password data.
