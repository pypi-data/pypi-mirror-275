...
from hashboard.api import create_data_source, login, test_data_source, update_data_source
...
def mutate_datasource_from_subtype(ctx, subtype: DatabaseTypes, is_update: bool = False, **kwargs):
