...
class OrbitPropagationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deltaInclination", "deltaEccentricity", "deltaSemiMajorAxis", "numberOfPeriods", "ephemerides", "fieldIndexes", "ephemeridesFrame", "errors", "warnings"]
