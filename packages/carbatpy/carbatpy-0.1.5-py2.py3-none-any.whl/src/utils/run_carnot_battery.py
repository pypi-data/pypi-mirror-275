...
if __name__ == "__main__":
    ...
    # pressures (p in Pa)
    _ETA_S_ = 0.77  # interesting when changed from 0.69 to 0.65, the efficiency
    ...
    cop = hp0.calc_heat_pump(FIXED_POINTS["p_high"], verbose=True)
    print(hp0.evaluation)
    ...
    T_SATL = _COLD_STORAGE_T_IN_ + _D_T_MIN_ + _T_INCREASE_COND #BA 2024-05-21 be careful
