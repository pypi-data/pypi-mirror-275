...
def stitch_function_for_ap1_for_old_cohort():
     ...
     import process_ap1_for_old_cohort
     importlib.reload(process_ap1_for_old_cohort)
     combined_school_df_file_path = process_ap1_for_old_cohort.process_for_rawDataCurrent(BASE_PATH, table_name, cohort_year, PATH_TO_OLD_COHORT_DATA_FILES)
...
if __name__ == '__main__':
     stitch_function_for_ap1_for_old_cohort()
