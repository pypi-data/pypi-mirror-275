...
def complie_ap3_dataframe_by_gender_for_given_school(cohort_year, entry_term, student_type, rawdatacurrent_file_path, BASE_PATH, table_name):
     import json
     import os
     import pandas as pd
     import sys
     ...
     if not all(item in accepted_gender_values for item in gender_values_in_data):
          ...
          for i in gender_values_in_data:
               ...
               sys.path.insert(0,BASE_PATH + '/all_partner_data_part_3/ap3_module_data_processing/')
               import function_common_ap3_calculate_values
               importlib.reload(function_common_ap3_calculate_values)
               current_file_values_df = function_common_ap3_calculate_values.get_ap3_values(BASE_PATH, filtered_df)
...
if __name__ == "__main__":
     ...
     complie_ap3_dataframe_by_gender_for_given_school(cohort_year, entry_term, student_type, rawdatacurrent_file_path, BASE_PATH, table_name)
