...
def process_for_rawDataCurrent(BASE_PATH, table_name):
     ...
     import function_ap3_create_one_school_data
     importlib.reload(function_ap3_create_one_school_data)
     ...
     for i in entry_term_list:
          for j in student_type_list:
               ...
               for school_no in range(len(rawDataCurrent_files_info)):
                    ...
                    try:
                         current_school_df  = function_ap3_create_one_school_data.complie_ap3_dataframe_for_given_school(current_cohort_year, current_entry_term, current_student_type, rawdatacurrent_file_path, BASE_PATH, table_name)
