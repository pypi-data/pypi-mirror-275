...
def get_ap_values_commitment_rate(master_df):
     import pandas as pd
     import sys
     import importlib
     ...
     function_dataframe['commitment_rate_not_in_comm_and_in_comm_as_committed'] = [commitment_rate_not_in_comm_and_in_comm_as_committed]
     function_dataframe['commitment_rate_in_comm_in_comm_prior_to_committed'] = [commitment_rate_in_comm_in_comm_prior_to_committed]
     ...
     function_dataframe['commitment_rate_in_comm_as_accepted'] = [commitment_rate_in_comm_as_accepted]
