...
def stitch_function_for_ap3_for_config_schools():
     import sys
     import importlib
     ...
     print("Starting main stitch for ap3 for config schools")
     sys.path.insert(0,BASE_PATH + '/all_partner_data_part3/ap3_module_data_processing/')
     import process_ap3_for_config_schools
     importlib.reload(process_ap3_for_config_schools)
     combined_school_df_file_path = process_ap3_for_config_schools.process_for_rawDataCurrent(BASE_PATH, table_name)
     ...
     print("ap3 for config schools process complete. \nEnd time =", dt_string)
     print("Total time for processing:", end_time - start_time)

if __name__ == '__main__':
     stitch_function_for_ap3_for_config_schools()
