...
def concat_and_update_athena_table(BASE_PATH, table_name, combined_school_df_file_path):
     ...
     import function_ap3_recreate_full_table
     importlib.reload(function_ap3_recreate_full_table)
     path_to_local_csv_file = function_ap3_recreate_full_table.recreate_full_table(BASE_PATH, table_name, combined_school_df_file_path)
...
if __name__ == '__main__':
     combined_school_df_file_path = '/home/luis/Zemee College_data_project/etl_code/data_team_etl/data_store/data_in_csv_for_tables/all_partner_data_part3_by_genderFallFirst_time.csv'
