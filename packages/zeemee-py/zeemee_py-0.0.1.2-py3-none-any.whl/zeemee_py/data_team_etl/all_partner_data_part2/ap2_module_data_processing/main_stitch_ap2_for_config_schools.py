...
def stitch_function_for_ap2_for_config_schools():
     import sys
     import importlib
     ...
     import process_ap2_for_config_schools
     importlib.reload(process_ap2_for_config_schools)
     combined_school_df_file_path = process_ap2_for_config_schools.process_for_rawDataCurrent(BASE_PATH, table_name)
...
if __name__ == '__main__':
     stitch_function_for_ap2_for_config_schools()
