...
def stitch_function_for_op2_for_old_cohort():
     ...
     print("Starting main stitch for op2 for config schools")
     sys.path.insert(0,BASE_PATH + '/one_pager_data_part2/op2_module_data_processing/')
     import process_op2_for_old_cohort
     importlib.reload(process_op2_for_old_cohort)
     combined_school_df_file_path = process_op2_for_old_cohort.process_for_zeemee_college_combined_files(BASE_PATH, table_name, cohort_year, PATH_TO_OLD_COHORT_COMBINED_FILES)
