...
def stitch_function_for_op2_for_config_schools():
     import sys
     import importlib
     ...
     import process_op2_for_config_schools
     importlib.reload(process_op2_for_config_schools)
     combined_school_df_file_path = process_op2_for_config_schools.process_for_zeemee_college_combined_files(BASE_PATH, table_name)
     ...
     print("op2 for config schools process complete. \nEnd time =", dt_string)
     print("Total time for processing:", end_time - start_time)

if __name__ == '__main__':
     stitch_function_for_op2_for_config_schools()
