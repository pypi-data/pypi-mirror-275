...
def process_by_gender_for_zeemee_college_combined_files(BASE_PATH, table_name, cohort_year, PATH_TO_OLD_COHORT_COMBINED_FILES):
     ...
     if len(is_null_in_rows) > 0:
          for i in range(len(is_null_in_rows)):
               if is_null_in_rows[i] == True:
                    ...
                    not_processed_reason.append('null value in combined_files_info')
     ...
     import function_op1_by_gender_create_one_school_data
     importlib.reload(function_op1_by_gender_create_one_school_data)
     ...
     for i in entry_term_list:
          for j in student_type_list:
               ...
               for school_no in range(len(combined_files_info)):
                    ...
                    try:
                         current_school_df  = function_op1_by_gender_create_one_school_data.complie_op1_dataframe_by_gender_for_given_school(current_cohort_year, current_entry_term, current_student_type, combined_file_path, BASE_PATH, table_name)
...
if __name__ == '__main__':
     ...
     process_by_gender_for_zeemee_college_combined_files(BASE_PATH, table_name, cohort_year, PATH_TO_OLD_COHORT_COMBINED_FILES)
