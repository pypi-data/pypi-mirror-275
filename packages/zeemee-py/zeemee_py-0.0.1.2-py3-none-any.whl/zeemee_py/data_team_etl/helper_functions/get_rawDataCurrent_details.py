...
def get_files_in_rawDataCurrent_folder():
     ...
     list_of_files_in_dir = glob.glob("/home/luis/Zemee College_data_project/rawDataCurrent/*")
     ...
     rawDataCurrent_files_info = partner_df.merge(rawDataCurrent_files_info,
                                            on = 'org_id',
                                            how = 'left')
