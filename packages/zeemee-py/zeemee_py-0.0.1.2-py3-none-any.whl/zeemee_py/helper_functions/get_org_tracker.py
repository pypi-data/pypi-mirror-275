def get_file():
     ...
     org_tracker_path_in_s3 = os.path.join("s3://", datateams3bucket,"zeemee_py/operations/org_data_tracker.csv")
     org_tracker_df = connect_duckdb.get_file_df(org_tracker_path_in_s3)
     
     return org_tracker_df
