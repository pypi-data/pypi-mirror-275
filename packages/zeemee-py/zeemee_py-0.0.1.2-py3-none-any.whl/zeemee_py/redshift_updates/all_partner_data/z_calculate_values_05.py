def calculate_values(master_df):
     ...
     #1.3.1
     #yield_rateall_regardless_of_joinstage
     numerator = len(master_df[
          (master_df['ZM.Enrolled'] == 1) & (master_df['ZM.Community'] == 'Community')
          ])
     denominator = len(master_df[
          (master_df['ZM.Accepted'] == 1) & (master_df['ZM.Community'] == 'Community')
          ])
     if denominator>0: 
          yield_rateall_regardless_of_joinstage = round(numerator/denominator,3)
     else: yield_rateall_regardless_of_joinstage = ""
     ...
     if denominator>0:
         yield_rate_in_comm_as_deposit = round(numerator/denominator,3)
     else: yield_rate_in_comm_as_deposit = ''
     
     
     function_dataframe['yield_rate_never_in_community'] = [yield_rate_never_in_community]
     function_dataframe['yield_rate_not_in_comm_in_comm_as_deposit'] = [yield_rate_not_in_comm_and_in_comm_as_committed]
     function_dataframe['yield_rate_in_comm_in_comm_prior_to_deposit'] = [yield_rate_in_comm_in_comm_prior_to_committed]
     function_dataframe['yield_rateall_regardless_of_joinstage'] = [yield_rateall_regardless_of_joinstage]
     ...
     function_dataframe['yield_rate_in_comme_as_applied'] = [yield_rate_in_comm_as_applied]
     ...
     function_dataframe['yield_rate_in_comm_as_deposit'] = [yield_rate_in_comm_as_deposit]
