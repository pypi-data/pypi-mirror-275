...
def calculate_values(master_df):
     ...
     function_dataframe['missing_inq_date'] = [percent_missing_inquired_date_in_comm]
     function_dataframe['missing_app_date'] = [percent_missing_applied_date_in_comm]
     function_dataframe['missing_comp_app_date'] = [percent_missing_comp_app_date_in_comm]
     function_dataframe['missing_acc_date'] = [percent_missing_accepted_date_in_comm]
     function_dataframe['missing_commit_date'] = [percent_missing_committed_date_in_comm]
