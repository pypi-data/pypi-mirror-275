...
def stitch_function_for_ap3_by_gender_for_config_schools():
     import sys
     import importlib
     ...
     import process_ap3_by_gender_for_config_schools
     importlib.reload(process_ap3_by_gender_for_config_schools)
     combined_school_df_file_path = process_ap3_by_gender_for_config_schools.process_by_gender_for_rawDataCurrent(BASE_PATH, table_name)
...
if __name__ == '__main__':
     stitch_function_for_ap3_by_gender_for_config_schools()
