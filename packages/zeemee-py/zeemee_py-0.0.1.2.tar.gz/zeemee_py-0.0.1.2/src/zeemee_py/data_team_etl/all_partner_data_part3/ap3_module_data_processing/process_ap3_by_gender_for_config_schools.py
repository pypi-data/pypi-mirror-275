...
def process_by_gender_for_rawDataCurrent(BASE_PATH, table_name):
...
if __name__ == '__main__':
     BASE_PATH = "/home/luis/Zemee College_data_project/etl_code/data_team_etl"
     table_name = 'all_partner_data_part3_by_gender'
     combined_school_df_file_path_list = process_by_gender_for_rawDataCurrent(BASE_PATH, table_name)
