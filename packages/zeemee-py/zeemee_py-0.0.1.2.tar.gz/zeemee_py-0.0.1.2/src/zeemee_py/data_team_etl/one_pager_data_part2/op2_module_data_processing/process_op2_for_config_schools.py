...
def process_for_zeemee_college_combined_files(BASE_PATH, table_name):
     ...
     #dropping rows that have NAs to avoid error in running one pager data report
          ...
          for j in student_type_list:
               ...
               for school_no in range(len(zeemee_college_combined_files_info)):
                    ...
                    try:
                         ...
                         print("\terror in function_op_create_one_school_data for " + school_name + ' ' + str(current_cohort_year) + current_entry_term + current_student_type.replace(' ', '_') + ' error:' + str(e))
                         organizations_not_processed.append(school_name)
                         not_processed_reason.append('error in function_op_create_one_school_data')
...
if __name__ == '__main__':
     ...
     process_for_zeemee_college_combined_files(BASE_PATH,table_name)
     #combined_file_path = '/home/luis/Zemee College_data_project/rawDataCurrent/Alfred University_college.csv'
