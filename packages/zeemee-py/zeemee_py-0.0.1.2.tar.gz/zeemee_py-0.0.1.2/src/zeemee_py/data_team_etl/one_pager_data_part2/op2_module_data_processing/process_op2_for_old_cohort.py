...
def process_for_zeemee_college_combined_files(BASE_PATH, table_name, cohort_year, PATH_TO_OLD_COHORT_COMBINED_FILES):
     ...
     import function_op2_create_one_school_data
     importlib.reload(function_op2_create_one_school_data)
     ...
     for i in entry_term_list:
          for j in student_type_list:
               ...
               for school_no in range(len(combined_files_info)):
                    ...
                    try:
                         current_school_df  = function_op2_create_one_school_data.complie_op2_dataframe_for_given_school(current_cohort_year, current_entry_term, current_student_type, combined_file_path, BASE_PATH, table_name)
                         ...
                         print("\terror in function_op2_create_one_school_data for " + school_name + ' ' + str(current_cohort_year) + current_entry_term + current_student_type.replace(' ', '_') + ' error:' + str(e))
