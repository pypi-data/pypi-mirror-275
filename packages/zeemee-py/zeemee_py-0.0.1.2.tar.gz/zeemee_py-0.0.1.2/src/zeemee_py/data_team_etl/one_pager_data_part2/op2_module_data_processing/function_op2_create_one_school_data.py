...
def complie_op2_dataframe_for_given_school(cohort_year, entry_term, student_type, zeemee_college_file_path, BASE_PATH, table_name):
     import json
     import os
     import pandas as pd
     import sys
     ...
     if len(master_df) <= 0:
          ...
          current_file_values_df = function_common_op2_calculate_values.get_op2_values(BASE_PATH, master_df)
...
if __name__ == "__main__":
     ...
     file = complie_op2_dataframe_for_given_school(cohort_year, entry_term, student_type, zeemee_college_file_path, BASE_PATH, table_name)
     file.to_csv("/home/luis/Zemee College_data_project/etl_code/data_team_etl/one_pager_data_part2/op2_module_data_processing/test_data.csv", index = False)
