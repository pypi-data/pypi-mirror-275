...
def complie_op1_dataframe_by_gender_for_given_school(cohort_year, entry_term, student_type, zeemee_college_file_path, BASE_PATH, table_name):
     import json
     import os
     import pandas as pd
     import sys
     ...
     if not all(item in accepted_gender_values for item in gender_values_in_data):
          ...
          for i in gender_values_in_data:
               ...
               current_file_values_df = function_common_op1_calculate_values.get_op1_values(BASE_PATH, filtered_df)
...
if __name__ == "__main__":
     ...
     file = complie_op1_dataframe_by_gender_for_given_school(cohort_year, entry_term, student_type, zeemee_college_file_path, BASE_PATH, table_name)
