...
def concat_and_update_athena_table(BASE_PATH, table_name, combined_school_df_file_path):
     ...
     import function_op1_recreate_full_table
     importlib.reload(function_op1_recreate_full_table)
     path_to_local_csv_file = function_op1_recreate_full_table.recreate_full_table(BASE_PATH, table_name, combined_school_df_file_path)
...
if __name__ == '__main__':
     combined_school_df_file_path = '/home/luis/Zemee College_data_project/data-team/data_team_etl/data_store/data_in_csv_for_tables/one_pager_data_part1_FallFirst_time.csv'
