"""
This function does all the calculations for a given file. So if you want 
separate calculations for each genders, pass dataframe filtered for different 
genders in a loop and join the results. This will be useful if we want to add 
further groups types like first gen, campus visits, etc in the table data
"""

def get_ap_values(master_df):
     import pandas as pd
     import sys
     import importlib
     ...
     function_dataframe['total_funnel_committed'] = [total_funnel_committed]
     function_dataframe['total_funnel_net_committed_enrolled'] = [total_funnel_net_committed_enrolled]
     ...
     function_dataframe['non_comm_funnel_committed'] = [non_comm_funnel_committed]
     function_dataframe['non_comm_funnel_net_committed_enrolled'] = [non_comm_funnel_net_committed_enrolled]
     #___________________________________
     ...
     function_dataframe['comm_funnel_inquired'] = [comm_funnel_inquired]
     function_dataframe['comm_funnel_applied'] = [comm_funnel_applied]
     function_dataframe['comm_funnel_comp_app'] = [comm_funnel_comp_app]
     function_dataframe['comm_funnel_accepted'] = [comm_funnel_accepted]
     function_dataframe['comm_funnel_committed'] = [comm_funnel_committed]
     function_dataframe['comm_funnel_net_committed_enrolled'] = [comm_funnel_net_committed_enrolled]
     #___________________________________
     ...
     function_dataframe['percent_inquired_in_community'] = [percent_inquired_in_community]
     ...
     function_dataframe['percent_accepts_in_community'] = [percent_accepts_in_community]
     function_dataframe['percent_commits_in_community'] = [percent_commits_in_community]
     function_dataframe['percent_net_committed_enrolled_in_community'] = [percent_net_committed_enrolled_in_community]
     #___________________________________
     ...
     function_dataframe['unadjusted_non_comm_committed_rate'] = [unadjusted_non_comm_committed_rate]
     function_dataframe['unadjusted_community_committed_rate'] = [unadjusted_community_committed_rate]
     ...
     function_dataframe['comm_delta_committed_rate_unadjusted'] = [comm_delta_committed_rate_unadjusted]
