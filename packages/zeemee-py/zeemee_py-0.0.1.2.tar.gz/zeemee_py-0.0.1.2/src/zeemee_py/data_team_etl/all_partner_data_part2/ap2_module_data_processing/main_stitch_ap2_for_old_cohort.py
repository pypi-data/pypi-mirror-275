...
def stitch_function_for_ap2_for_old_cohort():
     ...
     import process_ap2_for_old_cohort
     importlib.reload(process_ap2_for_old_cohort)
     combined_school_df_file_path = process_ap2_for_old_cohort.process_for_rawDataCurrent(BASE_PATH, table_name, cohort_year, PATH_TO_OLD_COHORT_DATA_FILES)
     ...
     print("ap2 for config schools process complete. \nEnd time =", dt_string)
     print("Total time for processing:", end_time - start_time)

if __name__ == '__main__':
     stitch_function_for_ap2_for_old_cohort()
