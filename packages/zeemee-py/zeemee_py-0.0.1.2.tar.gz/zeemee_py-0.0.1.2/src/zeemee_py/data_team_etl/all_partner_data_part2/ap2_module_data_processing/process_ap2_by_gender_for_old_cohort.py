...
def process_by_gender_for_rawDataCurrent(BASE_PATH, table_name, cohort_year, PATH_TO_OLD_COHORT_DATA_FILES):
     ...
     import function_ap2_by_gender_create_one_school_data
     importlib.reload(function_ap2_by_gender_create_one_school_data)
     ...
     for i in entry_term_list:
          for j in student_type_list:
               ...
               for school_no in range(len(rawDataCurrent_files_info)):
                    ...
                    try:
                         current_school_df  = function_ap2_by_gender_create_one_school_data.complie_ap2_dataframe_by_gender_for_given_school(current_cohort_year, current_entry_term, current_student_type, rawdatacurrent_file_path, BASE_PATH, table_name)
