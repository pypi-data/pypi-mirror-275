...
def complie_ap2_dataframe_for_given_school(cohort_year, entry_term, student_type, rawdatacurrent_file_path, BASE_PATH, table_name):
     import json
     import os
     import pandas as pd
     import sys
     ...
     #table_name = "all_partner_data_part2"
     ...
     if len(master_df) <= 0:
          ...
          current_file_values_df = function_common_ap2_calculate_values.get_ap2_values(BASE_PATH, master_df)
