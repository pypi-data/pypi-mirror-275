def calculate_values(master_df):
     ...
     denominator = len(master_df[
          (master_df['ZM.Committed'] == 1) & (master_df['ZM.Community'] == 'Community')]
          )
     
     if denominator > 0:
          melt_rate_in_communtyall = round((denominator-numerator)/denominator,3)
     else: melt_rate_in_communtyall = ""
     ...
     function_dataframe['melt_rate_in_communtyall'] = [melt_rate_in_communtyall]
     ...
     function_dataframe['melt_rate_in_comm_as_comp_accept'] = [melt_rate_in_comm_as_accepted]
     function_dataframe['melt_rate_in_comm_as_commitment'] = [melt_rate_in_comm_as_committed]
