...
def calculate_values(master_df):
     ...
     function_dataframe['app_rate_never_in_community_with_stealth'] = [app_rate_not_in_comm_and_in_comm_as_app_and_after]
     function_dataframe['app_rate_not_in_comm_in_comm_as_app_after'] = [app_rate_not_in_comm_and_in_comm_as_app_and_after]
     function_dataframe['app_rate_not_in_comm_in_comm_as_app_after_sans_stealth'] = [app_rate_not_in_comm_and_in_comm_as_app_and_after_sans_stealth]
