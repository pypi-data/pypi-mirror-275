...
def performSpineAnalysis1(
    ...
    for i in iRange:
        ...
        if not useCustomSpineModelDef:
            ...
            # spineDataSagCustom = np.zeros((1,2))
            ...
            for defPW in customSpineModelDef['model_sag']:
                ...
                # spineDataSagCustom = np.vstack((spineDataSagCustom[:-1,:], spineDataSagPW))
            ...
            # spineDataSag = spineDataSagCustom          
...
#        spineDataFro = spineData[i,2:0:-1,:].T # Np x 2
    ...
    #        spineLineFroDer = spine.calcSplineTangentSlopes(spineDataFro, u='only_pts')
            ...
            # spineDataFroCustom = np.zeros((1,2))
            ...
            for defPW in customSpineModelDef['model_fro']:
                ...
                # spineDataFroCustom = np.vstack((spineDataFroCustom[:-1,:], spineDataFroPW))
            ...
            # spineDataFro = spineDataFroCustom      
