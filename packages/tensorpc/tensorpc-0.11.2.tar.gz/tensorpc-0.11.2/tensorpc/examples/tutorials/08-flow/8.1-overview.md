...
class App:
    ...
    def my_layout(self):
        ...
        nodes = [
            ...
            flow.Node(id="2-2", type="tools", data=flow.NodeData(component=mui.Fragment([
                flow.NodeToolbar([
                    mui.ButtonGroup([
            ...
            flow.Node(id="2-3", type="resizer", data=flow.NodeData(component=mui.Fragment([
            ...
            flow.Node(id="3-2", type="textinput", data=flow.NodeData(component=mui.VBox([
                mui.VBox([
                    mui.VBox([
                        mui.HBox([
                ...
                flow.Handle(type="target", position="top"),

            ])), position=flow.XYPosition(150, 650), dragHandle=".custom-drag-handle"),
            flow.Node(id="3-1", type="circle", data=flow.NodeData(component=mui.Fragment([
                mui.HBox([
                    mui.HBox([
            ...
            ])), position=flow.XYPosition(350, 500)),
        ...
        edges = [
            ...
            flow.Edge("e3-3", source="2-3", sourceHandle="a", target="3-2", animated=True, style={
                "stroke": 'rgb(158, 118, 255)', "strokeWidth": 2
            }),
            flow.Edge("e3-4", source="2-3", sourceHandle="b", target="3-1", style={
                "strokeWidth": 2
            }),
