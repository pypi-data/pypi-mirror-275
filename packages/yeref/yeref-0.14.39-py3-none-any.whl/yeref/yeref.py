...
<body>
    <div class="container">
        ...
        <div class="jetton">
            ...
            <div id="hint-field-image" class="hint">&lt; 5 Mb .jpg,&nbsp;
                <div id="link-png" class="hint">.png,</div>&nbsp;
                <div id="link-webp" class="hint">.webp,</div>&nbsp;
                <div id="link-svg" class="hint">.svg</div>&nbsp;512х512
            </div>
        ...
        <div class="edit">
            ...
            <div class="block">
                <input type="text" id="input-mint" class="input-field" placeholder="1: количество NFT"
                    maxlength="256">
            ...
            <div class="block">
                <input type="text" id="input-burn" class="input-field" placeholder="1: количество NFT"
                    maxlength="256">
            ...
            <div class="block-transfer">
                <div class="block-outer">
                    <div class="block-inner">
                        <input type="text" id="input-amount" class="input-field-second" placeholder="1/EQ: индекс или адрес NFT"
                            maxlength="256">
                    </div>
                    <input type="text" id="input-address" class="input-field-second" placeholder="EQ: адрес кошелька"
                        maxlength="256">
    ...
    <script>
        ...
        document.getElementById('address-datalist-id').addEventListener('change', async () => {{
            ...
            document.getElementById('input-burn').placeholder = `1/EQ: индекс или адрес NFT`
            document.getElementById('input-mint').placeholder = `1/EQ: индекс или адрес NFT`
