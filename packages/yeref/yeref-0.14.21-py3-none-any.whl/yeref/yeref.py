...
<body>
    <div class="container">
        ...
        <div class="edit">
            ...
            <div class="hint">необязательный отзыв прав админа на: отчеканивание новых NFT и передачу прав
            ...
            <div class="block">
                <input type="number" id="input-burn" class="input-field" placeholder="1: количество NFT"
                    maxlength="256">
