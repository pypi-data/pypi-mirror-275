...
<body>
    <div class="container">
        ...
        <div class="choose-address">
            <div class="subscribe-datalist">
                ...
                <datalist id="address-datalist-list">
                    ...
                    <option value="post">сохранить авторский пост</option>
                </datalist>
            </div>
            <div id="choose-address-id" class="hint">выбери адрес</div>
        </div>
        ...
        <div class="nft">
            <div class="upload-media-nft">
                <label id="media-number">1/2</label>
                ...
                <input type="file" id="image-upload-nft" accept=".jpg, .jpeg, .webp, .png, .svg">
            </div>
            ...
            <div id="hint-field-nft-image" class="hint">&lt; 5 Mb .jpg, .png, .webp, .svg 256х256</div>
                ...
                <div class="block-outer">
                    <div class="block-inner">
                        <input type="text" id="input-amount" class="input-field-second"
                            placeholder="1/EQ: индекс или адрес NFT" maxlength="256">
                    </div>
                    <input type="text" id="input-address" class="input-field-second" placeholder="EQ: адрес кошелька"
                        maxlength="256">
                </div>
    ...
    <script>
        ...
        let images = ['https://telegra.ph/file/ec6662c7f9e5e17268e6a.jpg', 'https://telegra.ph/file/8854703af9aeb47aeabe7.jpg'];
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            document.querySelector('option[value="post"]').textContent = 'сохранить авторский пост'
            document.getElementById("choose-address-id").textContent = 'выбери адрес'
            document.getElementById("input-field-image").placeholder = "https: загрузи лого или вставь ссылку/base64"
        ...
        document.getElementById('attribute-add').addEventListener('click', async () => {{
            ...
            removeButton.id = 'attribute-remove'
