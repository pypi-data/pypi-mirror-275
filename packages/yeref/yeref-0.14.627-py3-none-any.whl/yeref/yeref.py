...
<body>
    ...
    <script>
        ...
        console.log(theme)
        if (theme === "DARK") {{
            document.querySelectorAll('.input-field').forEach(inputField => inputField.style.background = getComputedStyle(document.documentElement).getPropertyValue('--tg-theme-secondary-bg-color'));
        }}
