...
<body>
    <div class="container">
        ...
        <div class="edit">
            ...
            <div class="hint">необязательный отозыв прав админа на: отчеканивание новых NFT и передачу прав
                владения, а также на редактирование коллекции: ссылка на лого, название, описание</div>
    ...
    <script>
        ...
        document.getElementById('gen-rand').addEventListener('click', async () => {{
            if (isEdit) {{
                let res = await sendRequest('POST', '/nft-random', {{ 'initData': tg.initData }})
                console.log(res)
        ...
        document.getElementById('nft-send').addEventListener('click', async (event) => {{
            ...
            let res = await sendRequest('POST', '/nft-params', body)
            console.log(res)
