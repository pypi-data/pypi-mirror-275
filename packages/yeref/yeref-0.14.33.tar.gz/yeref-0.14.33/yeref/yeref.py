...
<body>
    <div class="container">
        ...
        <div class="jetton">
            ...
            <input type="text" id="input-field-percent" class="input-field" placeholder="5,5%: процент от перепродажи"
                maxlength="8">
            <div id="hint-field-percent" class="hint">роялти: процент от перепродажи отедельного NFT</div>

            <input type="text" id="input-field-royalty" class="input-field" placeholder="EQ: роялти адрес"
                maxlength="128">
            <div id="hint-field-royalty" class="hint">адрес, куда отправляется % от перепродажи NFT</div>
        ...
        <div class="edit">
            ...
            <div class="block-transfer">
                <div class="block-outer">
                    <div class="block-inner">
                        <input type="text" id="input-amount" class="input-field-second" placeholder="1/EQ: номер/адрес NFT"
                            maxlength="256">
                    </div>
                    <input type="text" id="input-address" class="input-field-second" placeholder="EQ: адрес кошелька"
                        maxlength="256">
    ...
    <script>
        ...
        tonConnectUI.onStatusChange(async () => {{
            if (tonConnectUI.connected) {{
                ...
                for (const key in collections) {{
                    ...
                    const option = document.createElement('option')
                    console.log('option:::: ', collect['collection'], collect['name'])
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            document.getElementById("hint-field-percent").textContent = "роялти: процент от перепродажи отедельного NFT"
            document.getElementById("input-field-royalty").placeholder = "EQ: роялти адрес"
            document.getElementById("hint-field-royalty").textContent = "адрес, куда отправляется % от перепродажи NFT"
            document.getElementById("gen-rand").textContent = "или сгенерируй рандом"
            document.getElementById("nft-edit").style.display = "none"
        ...
        document.getElementById('address-datalist-id').addEventListener('change', async () => {{
            ...
            document.getElementById("input-field-percent").value = ''
            document.getElementById("input-field-royalty").value = ''
