...
<body>
    ...
    <script>
        ...
        let lang = (tg.initData === '') ? 'en' : tg.initDataUnsafe['user']['language_code']
        let theme = tg.colorScheme.toUpperCase()
        document.querySelectorAll('.input-field').forEach(inputField => inputField.style.backgroundColor = theme === "DARK" ? getComputedStyle(document.documentElement).getPropertyValue('--tg-theme-secondary-bg-color') : '');
        let isEdit = true
        let admin = ""
        let wallet = ""
        let owner = ""
