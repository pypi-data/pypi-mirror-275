    ...
    <style>
        ...
        *::after {{
        ...
        #attribute-add {{
            ...
            color: rgba(140, 150, 160, 0.99);
            color: var(--tg-theme-section-header-text-color);
            border: 0.5px dashed rgba(50, 50, 50, 0.99) !important;
            line-height: 20px;
        }}
...
<body>
    <div class="container">
        ...
        <div class="edit">
            ...
            <div class="block">
                <input type="text" id="input-burn" class="input-field" placeholder="EQ: адрес NFT"
                    maxlength="256">
                ...
                <div class="block-outer">
                    <div class="block-inner">
                        <input type="text" id="input-amount" class="input-field-second"
                            placeholder="EQ: адрес NFT" maxlength="256">
                    </div>
                    <input type="text" id="input-address" class="input-field-second" placeholder="EQ: адрес кошелька"
                        maxlength="256">
                </div>
    ...
    <script>
        ...
        document.getElementById('address-datalist-id').addEventListener('change', async () => {{
            ...
            document.getElementById('input-burn').placeholder = `EQ: адрес NFT`
            document.getElementById('input-mint').placeholder = `EQ: адрес NFT`
