...
<body>
    <div class="container">
        ...
        <div class="choose-address">
            <div class="subscribe-datalist">
                ...
                <datalist id="address-datalist-list">
                    <option value="+">создать новую коллекцию</option>
                </datalist>
            </div>
            <div id="choose-address-id" class="hint">выбери адрес</div>
        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            document.getElementById("wallet-title").textContent = 'Адрес кошелька:'
            document.getElementById("owner-title").textContent = 'Подключенный кошелек:'
            document.getElementById("collection-title").textContent = 'Адрес мастера:'
        ...
        document.getElementById('gen-rand').addEventListener('click', async () => {{
            if (isEdit) {{
                ...
                let params = await sendRequest('POST', '/params', body)
                console.log('/params', params['collection'])
