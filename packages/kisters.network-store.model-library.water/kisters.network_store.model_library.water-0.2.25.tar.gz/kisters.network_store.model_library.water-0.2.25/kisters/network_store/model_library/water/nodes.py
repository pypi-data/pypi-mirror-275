...
class HBVParameters(_Node):
    ...
    ecf: Optional[float] = Field(1.0, description="Evaporation correction factor [-]")
    ...
    rfcf: Optional[float] = Field(1.0, description="Correction factor for rainfall [-]")
    sfcf: Optional[float] = Field(1.0, description="Correction factor for snowfall [-]")
