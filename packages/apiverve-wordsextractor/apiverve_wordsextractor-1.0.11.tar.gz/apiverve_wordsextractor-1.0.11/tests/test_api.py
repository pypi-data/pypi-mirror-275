...
class TestWordsextractorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = WordsextractorAPIClient(self.api_key)

    @patch('apiverve_wordsextractor.apiClient.requests.get')
