...
import numpy as np
from deepfacesnap.modules import detection
from deepfacesnap.models.Detector import Detector, DetectedFace, FacialAreaRegion
from deepfacesnap.detectors import (
    FastMtCnn,
    MediaPipe,
    MtCnn,
    OpenCv,
