...
from dqlib.proto.dqanalytics_pb2 import *
from dqlib.proto.dqanalyticsservice_pb2 import *
from dqlib.proto.dqcmanalytics_pb2 import *
from dqlib.proto.dqcmanalyticsservice_pb2 import *
from dqlib.proto.dqcmmarket_pb2 import *
from dqlib.proto.dqcmmarketservice_pb2 import *
from dqlib.proto.dqcranalytics_pb2 import *
from dqlib.proto.dqcranalyticsservice_pb2 import *
from dqlib.proto.dqcrmarket_pb2 import *
from dqlib.proto.dqcrmarketservice_pb2 import *
from dqlib.proto.dqdatetime_pb2 import *
from dqlib.proto.dqdatetimeservice_pb2 import *
from dqlib.proto.dqeqanalytics_pb2 import *
from dqlib.proto.dqeqanalyticsservice_pb2 import *
from dqlib.proto.dqeqmarketservice_pb2 import *
from dqlib.proto.dqfianalytics_pb2 import *
from dqlib.proto.dqfianalyticsservice_pb2 import *
from dqlib.proto.dqfiapi_pb2 import *
from dqlib.proto.dqfimarket_pb2 import *
from dqlib.proto.dqfimarketservice_pb2 import *
from dqlib.proto.dqfxanalytics_pb2 import *
from dqlib.proto.dqfxanalyticsservice_pb2 import *
from dqlib.proto.dqfxmarket_pb2 import *
from dqlib.proto.dqfxmarketservice_pb2 import *
from dqlib.proto.dqgeneralapi_pb2 import *
from dqlib.proto.dqiranalytics_pb2 import *
from dqlib.proto.dqiranalyticsservice_pb2 import *
from dqlib.proto.dqirmarket_pb2 import *
from dqlib.proto.dqirmarketservice_pb2 import *
from dqlib.proto.dqlib_pb2 import *
from dqlib.proto.dqmarket_pb2 import *
from dqlib.proto.dqmarketrisk_pb2 import *
from dqlib.proto.dqmarketriskservice_pb2 import *
from dqlib.proto.dqmarketservice_pb2 import *
from dqlib.proto.dqnumerics_pb2 import *
from dqlib.proto.dqstaticdataservice_pb2 import *
...
def dqCreateProtoCmVolatilitySurfaceBuildingInput(p_reference_date, p_definition, p_quotes, p_underlying_prices, p_discount_curve, p_fwd_curve, p_build_settings, p_underlying, p_vol_surf):
    '''
    @args:
        1. p_reference_date: dqproto.Date
...
#BondTemplateRequest
def dqCreateProtoBondTemplateRequest(p_bond_mkt_code):
    '''
    @args:
        1. p_bond_mkt_code: string
    @return:
        dqproto.BondTemplateRequest
    '''
    try:
        tmp_this= BondTemplateRequest()
        tmp_this.bond_mkt_code=p_bond_mkt_code
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))

#BondTemplateResponse
def dqCreateProtoBondTemplateResponse(p_bond_template):
    '''
    @args:
        1. p_bond_template: dqproto.VanillaBondTemplate
    @return:
        dqproto.BondTemplateResponse
    '''
    try:
        tmp_this= BondTemplateResponse()
        tmp_this.bond_template.CopyFrom(p_bond_template)
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))
...
#BondRequest
def dqCreateProtoBondRequest(p_bond_mkt_code):
    '''
    @args:
        1. p_bond_mkt_code: string
    @return:
...
#BondResponse
def dqCreateProtoBondResponse(p_bond):
    '''
    @args:
        1. p_bond: dqproto.VanillaBond
    @return:
        dqproto.BondResponse
    '''
    try:
        tmp_this= BondResponse()
        tmp_this.bond.CopyFrom(p_bond)
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
...
#BondYieldCurveRequest
def dqCreateProtoBondYieldCurveRequest(p_curve_name, p_as_of_date):
    '''
    @args:
        1. p_curve_name: string
        2. p_as_of_date: string
    @return:
        dqproto.BondYieldCurveRequest
    '''
    try:
        tmp_this= BondYieldCurveRequest()
        tmp_this.curve_name=p_curve_name
        tmp_this.as_of_date=p_as_of_date
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))
...
def dqCreateProtoBondYieldCurveResponse(p_ir_yield_curve):
    '''
    @args:
        1. p_ir_yield_curve: dqproto.IrYieldCurve
    @return:
        dqproto.BondYieldCurveResponse
    '''
    try:
        tmp_this= BondYieldCurveResponse()
        tmp_this.ir_yield_curve.CopyFrom(p_ir_yield_curve)
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
...
#BondSpreadCurveRequest
def dqCreateProtoBondSpreadCurveRequest(p_curve_name, p_as_of_date):
    '''
    @args:
        1. p_curve_name: string
        2. p_as_of_date: string
    @return:
        dqproto.BondSpreadCurveRequest
    '''
    try:
        tmp_this= BondSpreadCurveRequest()
        tmp_this.curve_name=p_curve_name
        tmp_this.as_of_date=p_as_of_date
        return tmp_this
    except: # catch *all* exceptions
...
#BondSpreadCurveResponse
def dqCreateProtoBondSpreadCurveResponse(p_credit_curve):
    '''
    @args:
        1. p_credit_curve: dqproto.CreditCurve
    @return:
        dqproto.BondSpreadCurveResponse
    '''
    try:
        tmp_this= BondSpreadCurveResponse()
        tmp_this.credit_curve.CopyFrom(p_credit_curve)
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
...
def dqCreateProtoBondValuationRequest(p_bond_mkt_code, p_as_of_date):
    '''
    @args:
        1. p_bond_mkt_code: string
        2. p_as_of_date: string
    @return:
        dqproto.BondValuationRequest
    '''
    try:
        tmp_this= BondValuationRequest()
        tmp_this.bond_mkt_code=p_bond_mkt_code
        tmp_this.as_of_date=p_as_of_date
        return tmp_this
    except: # catch *all* exceptions
...
#BondValuation
def dqCreateProtoBondValuation(p_date_time, p_value_id, p_value, p_currency):
    '''
    @args:
        1. p_date_time: string
        2. p_value_id: string
        3. p_value: double
        4. p_currency: string
    @return:
        dqproto.BondValuation
    '''
    try:
        tmp_this= BondValuation()
        tmp_this.date_time=p_date_time
        tmp_this.value_id=p_value_id
        tmp_this.value=p_value
        tmp_this.currency=p_currency
        return tmp_this
    except: # catch *all* exceptions
...
def dqCreateProtoBondValuationResponse(p_bond_valuation):
    '''
    @args:
        1. p_bond_valuation: dqproto.BondValuation
    @return:
        dqproto.BondValuationResponse
    '''
    try:
        tmp_this= BondValuationResponse()
        tmp_this.bond_valuation.extend(p_bond_valuation)
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))
...
#BondVarRequest
def dqCreateProtoBondVarRequest(p_bond_mkt_code, p_as_of_date):
    '''
    @args:
        1. p_bond_mkt_code: string
        2. p_as_of_date: string
    @return:
        dqproto.BondVarRequest
    '''
    try:
        tmp_this= BondVarRequest()
        tmp_this.bond_mkt_code=p_bond_mkt_code
        tmp_this.as_of_date=p_as_of_date
        return tmp_this
    except: # catch *all* exceptions
...
#BondVar
def dqCreateProtoBondVar(p_date_time, p_value_id, p_value, p_currency):
    '''
    @args:
        1. p_date_time: string
        2. p_value_id: string
...
#BondVarResponse
def dqCreateProtoBondVarResponse(p_bond_var):
    '''
    @args:
        1. p_bond_var: dqproto.BondVar
    @return:
        dqproto.BondVarResponse
    '''
    try:
        tmp_this= BondVarResponse()
        tmp_this.bond_var.extend(p_bond_var)
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))
...
#BondParCurveRequest
def dqCreateProtoBondParCurveRequest(p_curve_name, p_as_of_date):
    '''
    @args:
        1. p_curve_name: string
        2. p_as_of_date: string
    @return:
        dqproto.BondParCurveRequest
    '''
    try:
        tmp_this= BondParCurveRequest()
        tmp_this.curve_name=p_curve_name
        tmp_this.as_of_date=p_as_of_date
        return tmp_this
    except: # catch *all* exceptions
...
#BondParCurveResponse
def dqCreateProtoBondParCurveResponse(p_bond_par_curve):
    '''
    @args:
        1. p_bond_par_curve: dqproto.BondParCurve
    @return:
        dqproto.BondParCurveResponse
    '''
    try:
        tmp_this= BondParCurveResponse()
        tmp_this.bond_par_curve.CopyFrom(p_bond_par_curve)
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
...
#CalendarRequest
def dqCreateProtoCalendarRequest(p_calendar_name):
    '''
    @args:
        1. p_calendar_name: string
    @return:
        dqproto.CalendarRequest
    '''
    try:
        tmp_this= CalendarRequest()
        tmp_this.calendar_name=p_calendar_name
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))
...
#CalendarResponse
def dqCreateProtoCalendarResponse(p_calendar):
    '''
    @args:
        1. p_calendar: dqproto.Calendar
    @return:
        dqproto.CalendarResponse
    '''
    try:
        tmp_this= CalendarResponse()
        tmp_this.calendar.CopyFrom(p_calendar)
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))
...
#IborIndexRequest
def dqCreateProtoIborIndexRequest(p_ibor_index_name):
    '''
    @args:
        1. p_ibor_index_name: string
    @return:
        dqproto.IborIndexRequest
    '''
    try:
        tmp_this= IborIndexRequest()
        tmp_this.ibor_index_name=p_ibor_index_name
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))
...
#IborIndexResponse
def dqCreateProtoIborIndexResponse(p_ibor_index):
    '''
    @args:
        1. p_ibor_index: dqproto.IborIndex
    @return:
        dqproto.IborIndexResponse
    '''
    try:
        tmp_this= IborIndexResponse()
...
#InstCodeRequest
def dqCreateProtoInstCodeRequest(p_inst_name):
    '''
    @args:
        1. p_inst_name: string
    @return:
        dqproto.InstCodeRequest
    '''
    try:
        tmp_this= InstCodeRequest()
        tmp_this.inst_name=p_inst_name
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
...
#InstCodeResponse
def dqCreateProtoInstCodeResponse(p_inst_code):
    '''
    @args:
        1. p_inst_code: string
    @return:
        dqproto.InstCodeResponse
    '''
    try:
        tmp_this= InstCodeResponse()
        tmp_this.inst_code=p_inst_code
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
        print(str(e))
...
#InstNameRequest
def dqCreateProtoInstNameRequest(p_inst_code):
    '''
    @args:
        1. p_inst_code: string
    @return:
        dqproto.InstNameRequest
    '''
    try:
        tmp_this= InstNameRequest()
        tmp_this.inst_code=p_inst_code
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
...
#InstNameResponse
def dqCreateProtoInstNameResponse(p_inst_name):
    '''
    @args:
        1. p_inst_name: string
    @return:
        dqproto.InstNameResponse
    '''
    try:
        tmp_this= InstNameResponse()
        tmp_this.inst_name=p_inst_name
        return tmp_this
    except: # catch *all* exceptions
        e = sys.exc_info()[0]
