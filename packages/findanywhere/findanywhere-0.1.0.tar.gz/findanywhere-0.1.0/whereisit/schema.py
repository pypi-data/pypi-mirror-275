...
class SearchSchema:
    ...
    def source_adapter(self) -> SourceAdapter:
        ...
        Description:
        This method returns a SourceAdapter object based on the given source name and configuration. The source name and configuration determine which SourceAdapter to use.
