...
from fastsapi.exceptions import RequestErrorModel
from fastsapi.types import IncEx, ModelNameMap, UnionType
...
if PYDANTIC_V2:
    ...
    from fastsapi.openapi.constants import REF_PREFIX as REF_PREFIX
