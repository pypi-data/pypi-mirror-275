...
class MatrixSquareSymmetric(AMatrixSquare):
    ...
    @staticmethod
    def createFromTLTU(neq, tl, opt_eigen=-1):
        return _gstlearn.MatrixSquareSymmetric_createFromTLTU(neq, tl, opt_eigen)

    @staticmethod
    def createFromTriangle(mode, neq, tl, opt_eigen=-1):
        return _gstlearn.MatrixSquareSymmetric_createFromTriangle(mode, neq, tl, opt_eigen)
...
class Model(AStringable, ASerializable, ICloneable):
    ...
    def evalDriftValue(self, ivar, ib, drftab):
        return _gstlearn.Model_evalDriftValue(self, ivar, ib, drftab)
    ...
    def evalDriftVarCoefVec(self, db, coeffs, ivar=0, useSel=False):
        return _gstlearn.Model_evalDriftVarCoefVec(self, db, coeffs, ivar, useSel)

    def evalDriftMat(self, *args, **kwargs):
        return _gstlearn.Model_evalDriftMat(self, *args, **kwargs)
    ...
    def covMatrixMS(self, db1, mode=None):
        return _gstlearn.Model_covMatrixMS(self, db1, mode)
...
class Option_AutoFit(AStringable):
    ...
    def isUseEigenLibrary(self):
        return _gstlearn.Option_AutoFit_isUseEigenLibrary(self)
    ...
    def setUseEigenLibrary(self, useEigenLibrary):
        return _gstlearn.Option_AutoFit_setUseEigenLibrary(self, useEigenLibrary)
...
class DriftList(AStringable, ICloneable):
    ...
    def getBetaHat(self):
        return _gstlearn.DriftList_getBetaHat(self)
    ...
    def evalDriftVec(self, *args, **kwargs):
        return _gstlearn.DriftList_evalDriftVec(self, *args, **kwargs)

    def evalDriftVecInPlace(self, db, iech, member, drftab):
        return _gstlearn.DriftList_evalDriftVecInPlace(self, db, iech, member, drftab)

    def evalDriftMat(self, *args, **kwargs):
        return _gstlearn.DriftList_evalDriftMat(self, *args, **kwargs)

    def evalDriftValue(self, ivar, ib, drftab):
        return _gstlearn.DriftList_evalDriftValue(self, ivar, ib, drftab)
