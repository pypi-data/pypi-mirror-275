...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_gift_wrap() != 2702:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_handle_notifications() != 28993:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_event_seen_on_relays() != 3595:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_event_by_id() != 18741:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_count() != 39553:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_query() != 55160:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_delete() != 41600:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_wipe() != 8668:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrconnectremotesigner_init() != 6872:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrdatabase_custom() != 2448:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD8 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_POINTER,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD9 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,UNIFFI_FOREIGN_FUTURE_COMPLETE_U64,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD10 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,UNIFFI_FOREIGN_FUTURE_COMPLETE_RUST_BUFFER,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD11 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD12 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
...
class _UniffiConverterTypeCustomNostrDatabase:
    ...
    @staticmethod
    def lift(value: int):
        return CustomNostrDatabase._make_instance_(value)

    @staticmethod
    def check_lower(value: CustomNostrDatabase):
        if not isinstance(value, CustomNostrDatabase):
            raise TypeError("Expected CustomNostrDatabase instance, {} found".format(type(value).__name__))
