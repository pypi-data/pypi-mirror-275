...
Example usage:
    python3 -m apeboiy.inav_predict \\
        --model-repo "kagglehub://username/repo" \\
        --model-name "model.onnx" \\
        --ply-file "data/pointclouds/csb_1f_low_binary.ply" \\
        --image-dir "seq01" \\
        --output-dir "dist" \\
        --num_images 1
...
""",
    ...
    parser.add_argument("-mr", "--model-repo", type=str, help="Path to the model repository.")
    parser.add_argument("-mn", "--model-name", type=str, help="Name of the model to download from KaggleHub.")
    parser.add_argument("-pf", "--ply-file", type=str, help="Path to the PLY file containing the point cloud.")
    parser.add_argument("-id", "--image-dir", type=str, help="Directory containing images to process.")
    parser.add_argument("-od", "--output-dir", type=str, help="Directory to save output images.")
    parser.add_argument("-ni", "--num-images", type=int, help="Number of images to process.")
    ...
    parser.add_argument("-nt", "--no-table", action="store_true", help="Do not generate a table of results.")
