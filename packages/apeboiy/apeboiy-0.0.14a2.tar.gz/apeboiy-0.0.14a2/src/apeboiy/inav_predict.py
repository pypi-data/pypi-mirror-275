...
class PointCloudPoseEstimation:
    def __init__(self, model_dir, model_name, ply_file, image_dir, output_dir, num_images, verbose=False):
...
"""
    ...
    parser.add_argument('--version', action='store_true', help='Display the version of the script.')
    ...
    if args.version:
        print(f"PointCloud Pose Estimation Script, Version {VERSION}")
        exit(0)
