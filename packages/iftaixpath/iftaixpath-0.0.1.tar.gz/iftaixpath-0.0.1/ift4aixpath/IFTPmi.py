...
from iftaixpath.IFTBase import IFTCore, IFTObject, IFTGeometryObject, IFTGeometryCollection
from iftaixpath.IFTMachiningPart import IFTMachiningPartCollection
