...
class FcusImagePrompt(BaseRequest):
    input_image: Optional[bytes] = Field(None, description="binary image, used for inpaint")
    input_mask: Optional[bytes] = Field(None, description="binary image mask, used for inpaint")
    inpaint_additional_prompt: str = ""
    outpaint_selections: str = Field(default="", description="Image extension direction, 'Left', 'Right', 'Top', 'Bottom' separated by commas")
    outpaint_distance_left: int = 0
    outpaint_distance_right: int = 0
    outpaint_distance_top: int = 0
    outpaint_distance_bottom: int = 0
    cn_img1: Optional[bytes] = Field(None, description="binary image")
    cn_stop1: float = 0.6
    cn_weight1: float = 0.6
    cn_type1: str = ""
    cn_img2: Optional[bytes] = Field(None, description="binary image")
    cn_stop2: float = 0.6
    cn_weight2: float = 0.6
    cn_type2: str = ""
    cn_img3: Optional[bytes] = Field(None, description="binary image")
    cn_stop3: float = 0.6
    cn_weight3: float = 0.6
    cn_type3: str = ""
    cn_img4: Optional[bytes] = Field(None, description="binary image")
    cn_stop4: float = 0.6
