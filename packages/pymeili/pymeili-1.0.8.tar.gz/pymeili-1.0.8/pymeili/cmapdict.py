        ...
        if index in ['-28','28','-27','-26','-25','-24','-23','-22','22','23','24','25','26','27','12','13','14','15','-12','-13','-14','-15','33','34','35','36','37','38','39','-33','-34','-35','-36','-37','-38','-39','43','44','45','46','47','48','49','-43','-44','-45','-46','-47','-48','-49','59','58','57','-57','-58','-59','-69','69','-79','79','-89','89','-99','99','-109','109','-119','119','-129','129', '-139', '139', '-149', '149', '-159', '159', '-169', '169', '-179', '179', '-189', '189', '-199', '199', '-209', '209','-219','219','-229','229','-239','239']:
            try:
                if theme == 'light':
                    ...
                    if index == '239':
                        return LinearSegmentedColormap.from_list('mycmap',["#B238CB","#66429A","#3E4681","#5B6699","#7785B0","#AEC0DF","#DFEBFA","#F9F9F9","#FFE7CD","#FFB466","#FF6B3A","#E90000","#BC0000","#610000"])
                    if index == '-239':
                        return LinearSegmentedColormap.from_list('mycmap',["#610000","#BC0000","#E90000","#FF6B3A","#FFB466","#FFE7CD","#F9F9F9","#DFEBFA","#AEC0DF","#7785B0","#5B6699","#3E4681","#66429A","#B238CB"])
