...
class Command(BaseCommand):
    ...
    BASE_PATH = Path("django_django_fastoche/static/fastoche/dist")

    def handle(self, *args, **options):
        files = [
            {
                "path": "django_fastoche/fastoche.module.min.js",
                "constant": "INTEGRITY_JS_MODULE",
            },
            {
                "path": "django_fastoche/fastoche.nomodule.min.js",
                "constant": "INTEGRITY_JS_NOMODULE",
            },
            {"path": "django_fastoche/fastoche.min.css", "constant": "INTEGRITY_CSS"},
...
# python manage.py integrity_checksums\n\n"""
        ...
        with open("django_fastoche/checksums.py", "w") as output_file:
