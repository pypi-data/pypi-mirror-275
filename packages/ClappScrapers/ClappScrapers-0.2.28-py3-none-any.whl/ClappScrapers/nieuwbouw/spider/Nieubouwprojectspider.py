...
class NieuwbouwprojectspiderSpider(scrapy.Spider):
    ...
    base_url = 'https://www.nieuwbouw-nederland.nl/projecten/?hk[]=k&sort=titel_asc&p=1'
    ...
    def get_to_sell_project_page(self,resposne):
        ...
        yield scrapy.Request (url = 'https://www.nieuwbouw-nederland.nl/projecten/?fs=&hk[]=k&sort=titel_asc',callback = self.parse_projects)
