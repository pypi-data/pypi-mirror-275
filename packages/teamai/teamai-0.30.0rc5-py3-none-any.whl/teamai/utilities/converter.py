...
class Converter(BaseModel):
    ...
    def _create_instructor(self):
        ...
        from teamai.utilities import Instructor
    ...
    def _create_chain(self):
        """Create a chain."""
        from teamai.utilities.team_pydantic_output_parser import (
            TeamPydanticOutputParser,
        )

        parser = TeamPydanticOutputParser(pydantic_object=self.model)
