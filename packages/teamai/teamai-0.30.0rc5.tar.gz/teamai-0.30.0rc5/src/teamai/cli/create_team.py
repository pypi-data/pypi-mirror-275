...
def create_team(name):
    ...
    src_template_files = ["__init__.py", "main.py", "team.py"]
    ...
    click.secho(f"Team {name} created successfully!", fg="green", bold=True)
...
def copy_template(src, dst, name, class_name, folder_name):
    ...
    content = content.replace("{{team_name}}", class_name)
