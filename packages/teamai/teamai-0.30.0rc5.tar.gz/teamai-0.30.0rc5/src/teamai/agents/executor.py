...
from teamai.agents.tools_handler import ToolsHandler
from teamai.memory.entity.entity_memory_item import EntityMemoryItem
from teamai.memory.long_term.long_term_memory_item import LongTermMemoryItem
from teamai.memory.short_term.short_term_memory_item import ShortTermMemoryItem
from teamai.tools.tool_usage import ToolUsage, ToolUsageErrorException
from teamai.utilities import I18N
from teamai.utilities.converter import ConverterError
from teamai.utilities.evaluators.task_evaluator import TaskEvaluator
    ...
    def _create_short_term_memory(self, output) -> None:
        if (
            ...
            memory = ShortTermMemoryItem(
                data=output.log,
                agent=self.team_agent.role,
                metadata={
                    "observation": self.task.description,
                },
            )
            self.team._short_term_memory.save(memory)

    def _create_long_term_memory(self, output) -> None:
        if self.team and self.team.memory:
            ltm_agent = TaskEvaluator(self.team_agent)
            ...
            self.team._long_term_memory.save(long_term_memory)
            ...
            for entity in evaluation.entities:
                ...
                self.team._entity_memory.save(entity_memory)
