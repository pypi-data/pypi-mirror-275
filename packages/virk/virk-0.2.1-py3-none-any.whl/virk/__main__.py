...
parser = argparse.ArgumentParser(
    prog="virk",
    description="Typing via virsh made 'easier'. Implementation is incomplete. Default Keyboard Type is 'de'.",
    epilog="Useful? Donate: https://www.paypal.com/donate/?hosted_button_id=4EZE2QKKG29JE THANK YOU")
...
parser.add_argument("--inline", action="store_true", help="Use FILENAME as KEY SOURCE")
parser.add_argument("--ctrl-alt-del", action="store_true", help="press CTRL-ALT-DELETE (same en/de)")
parser.add_argument("--win-cmd", action="store_true", help="assume windows - start a shell")
