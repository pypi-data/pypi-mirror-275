"""
sentineltoolkit.exceptions provide all Warning and Error classes
"""
...
__all__: list[str] = ["S3BucketCredentialNotFoundError", "CredentialTargetNotSupportedError"]
...
class CredentialTargetNotSupportedError(Exception):
    ...
    To know list of supported targets, just write: :obj:`sentineltoolkit.typedefs.Credentials.available_targets`
    """
