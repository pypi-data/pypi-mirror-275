...
class OpenAICapabilities(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["chat_params", b"chat_params", "optional_chat", b"optional_chat"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["chat_params", b"chat_params", "optional_chat", b"optional_chat"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["optional_chat", b"optional_chat"]) -> typing_extensions.Literal["chat_params"] | None: ...
