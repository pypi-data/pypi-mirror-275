...
class DeploymentManagementServiceMock(DeploymentManagementServiceServicer):
    ...
    def __deployment_brief_to_proto(self, deployment_details):
        return DeploymentBrief(
            ...
            environment_id=deployment_details["env"],
            variation_name=deployment_details['hosting_service'].kube_deployment.serving_strategy.realtime_config.traffic_config.selected_variation_name,
            variation_protect_state=deployment_details['hosting_service'].kube_deployment.serving_strategy.realtime_config.traffic_config.selected_variation_protect_state,
            deployment_id=deployment_details["deployment_id"]
        )
