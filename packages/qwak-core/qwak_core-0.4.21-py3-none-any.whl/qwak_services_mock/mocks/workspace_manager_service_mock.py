...
from _qwak_proto.qwak.workspace.workspace_pb2 import Workspace, WorkspaceImage, DefaultWorkspaceDetails
from _qwak_proto.qwak.workspace.workspace_service_pb2 import (
    ...
    UpdateWorkspaceResponse, CountWorkspacesRequest, CountWorkspacesResponse, GetDefaultWorkspaceValuesRequest,
...
class WorkspaceManagerServiceMock(WorkspaceManagementServiceServicer):
    ...
    def CountWorkspaces(self, request: CountWorkspacesRequest, context) -> CountWorkspacesResponse:
        return CountWorkspacesResponse(count=len(self.workspaces))

    def GetDefaultWorkspaceValues(self, request: GetDefaultWorkspaceValuesRequest, context) -> GetDefaultWorkspaceValuesResponse:
        return GetDefaultWorkspaceValuesResponse(
            default_workspace_details=DefaultWorkspaceDetails(
                ...
                cpu_compute_resources=ClientPodComputeResources(
                    template_spec=PodComputeResourceTemplateSpec(template_id=DEFAULT_CPU_INSTANCE)
                ),
                gpu_compute_resources=ClientPodComputeResources(
                    template_spec=PodComputeResourceTemplateSpec(template_id=DEFAULT_GPU_INSTANCE)
                ),
            )
        )
