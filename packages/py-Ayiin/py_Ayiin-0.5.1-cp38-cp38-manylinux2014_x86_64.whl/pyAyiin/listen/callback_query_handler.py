...
from techgram.types import CallbackQuery
...
@patch_into(techgram.handlers.callback_query_handler.CallbackQueryHandler)
class CallbackQueryHandler(
    techgram.handlers.callback_query_handler.CallbackQueryHandler
):
