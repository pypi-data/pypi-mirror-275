...
def area_tight(g: nx.Graph, pos: Union[str, dict, None] = None) -> float:
    """
        Returns the area of the convex hull of the networkx graph g
    :param g: A networkX graph
    :type g: nx.Graph
    :param pos: Optional node position dictionary. If not supplied, node positions are read from the graph directly.
                If given as a string, the property under the given name in the networkX graph is used.
...
def height(g: nx.Graph, pos: Union[str, dict, None] = None) -> numeric:
    """
        Returns the height of the graph, which is defined as the vertical distance between the lowest and the highest
        node.
    :param g: A networkX graph
    :type g: nx.Graph
    :param pos: Optional node position dictionary. If not supplied, node positions are read from the graph directly.
...
def width(g: nx.Graph, pos: Union[str, dict, None] = None) -> numeric:
    """
        Returns the width of the graph, which is defined as the horizontal distance between the left-most and the
        right-most node.
    :param g: A networkX graph
    :type g: nx.Graph
    :param pos: Optional node position dictionary. If not supplied, node positions are read from the graph directly.
...
def aspect_ratio(g: nx.Graph, pos: Union[str, dict, None] = None) -> Optional[float]:
    """
        Calculates the aspect ratio of the given graph. The aspect ratio is defined as the ratio of the bigger side
    ...
    :param pos: Optional node position dictionary. If not supplied, node positions are read from the graph directly.
                If given as a string, the property under the given name in the networkX graph is used.
    :type pos: Union[str, dic, None]
    :return: The aspect ratio of the graph.
