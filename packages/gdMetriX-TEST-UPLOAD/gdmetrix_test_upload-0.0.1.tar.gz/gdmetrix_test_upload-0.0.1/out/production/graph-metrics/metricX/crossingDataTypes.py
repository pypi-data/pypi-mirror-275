...
def __numeric_eq__(a: numeric, b: numeric) -> bool:
    return math.isclose(a, b, rel_tol=__precision)
...
class SweepLineStatus:
    ...
    def get_range(self, y: numeric, left_x: numeric, right_x: numeric) -> List[SweepLineEdgeInfo]:
        """
