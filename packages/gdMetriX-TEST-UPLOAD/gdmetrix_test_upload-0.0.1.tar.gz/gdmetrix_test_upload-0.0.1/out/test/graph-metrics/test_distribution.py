...
from metricX import distribution
...
class TestCenterOfMass(unittest.TestCase):
    ...
    def test_circle(self):
        ...
        x, y = distribution.center_of_mass(g)
...
class TestClosestPairOfPoints(unittest.TestCase):
    ...
    def test_empty_graph(self):
        ...
        closest_pair = distribution.closet_pair_of_points(g)
    ...
    def test_node_pair(self):
        ...
        a, b, distance = distribution.closet_pair_of_points(g)
...
class TestHomogeneity(unittest.TestCase):
    ...
    def test_big_even_graph_slightly_uneven(self):
        ...
        # TODO mention this example in the report that the metric does not make much sense to be honest
