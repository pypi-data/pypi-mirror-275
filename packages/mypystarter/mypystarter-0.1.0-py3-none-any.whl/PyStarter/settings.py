...
from mypystarter.enums import EnvironmentVariables
...
TENANT_MODEL = "mypystarter.Client"
TENANT_DOMAIN_MODEL = "mypystarter.Domain"
...
MIDDLEWARE = [
    ...
    'mypystarter.middlewares.RequestIDMiddleware',
]
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'mypystarter.exceptions.custom_exception_handler',
    'DEFAULT_VERSIONING_CLASS': 'mypystarter.base.version.VersioningMixin',
    'DEFAULT_VERSION': DEFAULT_API_VERSION,
    'ALLOWED_VERSIONS': ALLOWED_API_VERSIONS,
    'VERSION_PARAM': 'v',
    'DEFAULT_PAGINATION_CLASS': 'mypystarter.base.pagination.StandardResultsSetPagination',
...
AUTH_USER_MODEL = 'mypystarter.AppUser'
...
# STATICFILES_STORAGE = 'mypystarter.storages.s3.S3StaticStorage'
DEFAULT_FILE_STORAGE = 'mypystarter.storages.s3.PrivateS3Storage'
