...
from mypystarter.models import SoftDeletionModelMixin, TimeStampModel
...
class City(Model):
    ...
    country = ForeignKey('mypystarter.Country', on_delete=CASCADE, null=True, blank=True, related_name='cities')
...
class Client(TenantMixin, SoftDeletionModelMixin, TimeStampModel):
    ...
    city = ForeignKey('mypystarter.City', on_delete=CASCADE, null=True, blank=True)
