...
from mypystarter.models.soft import SoftDeletionModelMixin
from mypystarter.models.timestamp import TimeStampModel
from mypystarter.storages.s3 import S3PrivateStorage, S3PublicStorage
...
class File(SoftDeletionModelMixin, TimeStampModel):
    ...
    folder = models.ForeignKey('mypystarter.Folder', on_delete=models.CASCADE, null=True, blank=True)
