...
async def isMiddlewareFsub(filter, c: "pyrogram.Client", m: Message):
    member = None
    ...
    if (intDateNow == intExp or intExp > intDateNow):
        ...
        try:
            await bot.send_message(
                client._devs[0], f"<b> ✅ Bot {mention} dinonaktifkan karna masa penggunaan telah mencapai batas kedaluwarsa.</b>"
            )
        except:
            pass
        return False
