...
class V1beta3Subject(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": V1beta3GroupSubject.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "kind": obj.get("kind"),
            "serviceAccount": V1beta3ServiceAccountSubject.from_dict(obj["serviceAccount"]) if obj.get("serviceAccount") is not None else None,
            "user": V1beta3UserSubject.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
