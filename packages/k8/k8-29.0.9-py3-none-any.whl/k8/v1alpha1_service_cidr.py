...
class V1alpha1ServiceCIDR(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1ServiceCIDRSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1alpha1ServiceCIDRStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
