...
class Client(AsyncBaseClient):
    ...
    async def get_channel_by_resource_name(
        self, resource_name: str, namespace_id: str, **kwargs: Any
    ) -> Optional[
        Union[
            "GetChannelByResourceNameChannelByResourceNameChannel",
            "GetChannelByResourceNameChannelByResourceNameMsTeamsChannel",
        ...
        query = gql(
            """
            query GetChannelByResourceName($resourceName: String!, $namespaceId: String! = "default") {
    ...
    async def get_credential_by_resource_name(
        ...
        query = gql(
            """
            query GetCredentialByResourceName($resourceName: String!, $namespaceId: String! = "default") {
    ...
    async def get_identity_provider_by_resource_name(
        ...
        query = gql(
            """
            query GetIdentityProviderByResourceName($resourceName: String!, $namespaceId: String! = "default") {
    ...
    async def get_notification_rule_by_resource_name(
        ...
        query = gql(
            """
            query GetNotificationRuleByResourceName($resourceName: String!, $namespaceId: String! = "default") {
    ...
    async def get_segmentation_by_resource_name(
        ...
        query = gql(
            """
            query GetSegmentationByResourceName($resourceName: String!, $namespaceId: String! = "default") {
    ...
    async def get_source_by_resource_name(
        ...
        query = gql(
            """
            query GetSourceByResourceName($resourceName: String!, $namespaceId: String! = "default") {
    ...
    async def get_source_by_resource_name_deprecated(
        ...
        query = gql(
            """
            query GetSourceByResourceNameDeprecated($resourceName: String!, $resourceNamespace: String! = "default") {
    ...
    async def get_user_by_resource_name(
        ...
        query = gql(
            """
            query GetUserByResourceName($resourceName: String!, $namespaceId: String! = "default") {
              userByResourceName(resourceName: $resourceName, namespaceId: $namespaceId) {
                ...UserDetails
              }
            }
    ...
    async def get_validator_by_resource_name(
        ...
        query = gql(
            """
            query GetValidatorByResourceName($resourceName: String!, $namespaceId: String! = "default") {
    ...
    async def get_window_by_resource_name(
        ...
        query = gql(
            """
            query GetWindowByResourceName($resourceName: String!, $namespaceId: String! = "default") {
    ...
    async def segments_by_resource_name(
        ...
        query = gql(
            """
            query SegmentsByResourceName($resourceName: String!, $namespaceId: String! = "default") {
