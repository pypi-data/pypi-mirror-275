...
cliff_str2matrix = {
    ...
    "F2dg": np.array([[1.0 + 0.0j, 0.0 - 1.0j], [-1.0 + 0.0j, 0.0 - 1.0j]], dtype=dtype),
    "F3": np.array([[1.0 + 0.0j, 0.0 + 1.0j], [-1.0 + 0.0j, 0.0 + 1.0j]], dtype=dtype),
    "F3dg": np.array([[1.0 + 0.0j, -1.0 + 0.0j], [0.0 - 1.0j, 0.0 - 1.0j]], dtype=dtype),
...
def r1xy2cliff(theta: float, phi: float, *, atol: float = 1e-12, use_conv_table: bool = True) -> str | bool:
...
def rz2cliff(theta: float, *, atol: float = 1e-12, use_conv_table: bool = True) -> str | bool:
