...
class TransTimeGradEstimator(PyTorchLightningEstimator):
    """
    Estimator class to train a TransTimeGrad model.

    This class is uses the model defined in ``TransTimeGradModel``, and wraps it
    into a ``TransTimeGradLightningModule`` for training purposes: training is
    ...
    context_length
        Number of steps to unroll the Model for before computing predictions
        (default: None, in which case context_length = prediction_length).
    input_size:
        Number of variates in the input time series.
    num_layers
        Number of Model layers (default: 2).
    hidden_size
        Number of Model cells for each layer (default: 40).
    lr
    ...
    lags_seq
        Indices of the lagged target values to use as inputs of the Model
        (default: None, in which case these are automatically determined
        based on freq).
    time_features
        List of time features, from :py:mod:`gluonts.time_feature`, to use as
        inputs of the Model in addition to the provided data (default: None,
    ...
    def _create_instance_splitter(self, module: TransTimeGradLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: TransTimeGradLightningModule,
    ...
    def create_lightning_module(self) -> TransTimeGradLightningModule:
        return TransTimeGradLightningModule(
            # loss=self.loss,
            lr=self.lr,
