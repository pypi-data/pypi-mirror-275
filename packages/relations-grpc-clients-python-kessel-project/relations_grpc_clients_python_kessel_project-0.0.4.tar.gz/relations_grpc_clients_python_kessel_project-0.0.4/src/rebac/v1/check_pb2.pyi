...
from rebac.v1 import relationships_pb2 as _relationships_pb2
...
class CheckRequest(_message.Message):
    ...
    object: _relationships_pb2.ObjectReference
    relation: str
    subject: _relationships_pb2.SubjectReference
    def __init__(self, object: _Optional[_Union[_relationships_pb2.ObjectReference, _Mapping]] = ..., relation: _Optional[str] = ..., subject: _Optional[_Union[_relationships_pb2.SubjectReference, _Mapping]] = ...) -> None: ...
