...
def save_frames(
    ...
    while True:
        ...
        if redis_data["combined"] == "N":
            ...
            save_file_path = "{}.{}".format(DOWNLOAD_ROOT_DIR, redis_data["fileKey"], upload_file["file_type"].lower())
        else:
...
def zip_combined_files(
    ...
    zip_directory(
        ...
        "{}{}.zip".format(DOWNLOAD_ROOT_DIR, redis_data["fileKey"])
    )
