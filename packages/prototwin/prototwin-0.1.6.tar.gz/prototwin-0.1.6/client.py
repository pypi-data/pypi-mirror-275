...
_sz = 32768 * 8
_gb = prototwin_cmdbuff.get_bool
_gu = prototwin_cmdbuff.get_u32
_gi = prototwin_cmdbuff.get_i32
_gf = prototwin_cmdbuff.get_f32
_sb = prototwin_cmdbuff.set_bool
_su = prototwin_cmdbuff.set_u32
_si = prototwin_cmdbuff.set_i32
_sf = prototwin_cmdbuff.set_f32
...
class Client:    
    ...
    def get_bool(self, address: int) -> bool:
        return _gb(address)

    def get_u32(self, address: int) -> int:
        return _gu(address)

    def get_i32(self, address: int) -> int:
        return _gi(address)

    def get_f32(self, address: int) -> float:
        return _gf(address)

    def set_bool(self, address: int, value: bool) -> None:
        return _sb(address, value)

    def set_u32(self, address: int, value: int) -> None:
        return _su(address, value)

    def set_i32(self, address: int, value: int) -> None:
        return _si(address, value)

    def set_f32(self, address: int, value: float) -> None:
        return _sf(address, value)
