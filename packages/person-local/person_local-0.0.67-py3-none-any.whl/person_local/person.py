...
class Person:
    ...
    def generate_name(self) -> str:
        if self.first_name and self.last_name and self.main_email_address:
            return f'{self.first_name} {self.last_name} {self.main_email_address}'
        elif self.first_name and self.last_name:
            return f'{self.first_name} {self.last_name}'
        elif self.first_name and self.main_email_address:
            return f'{self.first_name} {self.main_email_address}'
