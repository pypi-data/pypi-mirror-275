...
class ComponentBoundsTargetMetric(betterproto.Enum):
    """
...
class MicrogridStub(betterproto.ServiceStub):
    ...
    async def add_component_exclusion_bounds(
        self,
        add_component_exclusion_bounds_request: "AddComponentExclusionBoundsRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ) -> "AddComponentExclusionBoundsResponse":
        return await self._unary_unary(
            "/frequenz.api.microgrid.v1.Microgrid/AddComponentExclusionBounds",
            add_component_exclusion_bounds_request,
            AddComponentExclusionBoundsResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def add_component_inclusion_bounds(
        self,
        add_component_inclusion_bounds_request: "AddComponentInclusionBoundsRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ) -> "AddComponentInclusionBoundsResponse":
        return await self._unary_unary(
            "/frequenz.api.microgrid.v1.Microgrid/AddComponentInclusionBounds",
            add_component_inclusion_bounds_request,
            AddComponentInclusionBoundsResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class MicrogridBase(ServiceBase):
    ...
    async def __rpc_add_component_exclusion_bounds(
        self,
        stream: "grpclib.server.Stream[AddComponentExclusionBoundsRequest, AddComponentExclusionBoundsResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.add_component_exclusion_bounds(request)
        await stream.send_message(response)

    async def __rpc_add_component_inclusion_bounds(
        self,
        stream: "grpclib.server.Stream[AddComponentInclusionBoundsRequest, AddComponentInclusionBoundsResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.add_component_inclusion_bounds(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/frequenz.api.microgrid.v1.Microgrid/AddComponentExclusionBounds": grpclib.const.Handler(
                self.__rpc_add_component_exclusion_bounds,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddComponentExclusionBoundsRequest,
                AddComponentExclusionBoundsResponse,
            ),
            "/frequenz.api.microgrid.v1.Microgrid/AddComponentInclusionBounds": grpclib.const.Handler(
                self.__rpc_add_component_inclusion_bounds,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddComponentInclusionBoundsRequest,
                AddComponentInclusionBoundsResponse,
            ),
