...
@deprecation.deprecated(deprecated_in="0.37.7", removed_in="0.52.0", current_version="0.48.1", details="function replaced with listOrgUserMacs")  
def getOrgUserMacs(mist_session:_APISession, org_id:str, blacklisted:bool=None, for_guest_wifi:bool=None, cross_site:bool=None, site_id:str, page:int=1, limit:int=100) -> _APIResponse:
    """
...
def listOrgUserMacs(mist_session:_APISession, org_id:str, blacklisted:bool=None, for_guest_wifi:bool=None, cross_site:bool=None, site_id:str, page:int=1, limit:int=100) -> _APIResponse:
    """
    API doc: https://doc.mist-lab.fr/#operation/listOrgUserMacs
