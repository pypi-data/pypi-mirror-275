...
class ExecuteCls:
	...
	def set(self) -> None:
		...
		Snippet: driver.trigger.gprf.generator.arb.segments.manual.execute.set() \n
	...
	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: TRIGger:GPRF:GENerator<Instance>:ARB:SEGMents:MANual:EXECute \n
		Snippet: driver.trigger.gprf.generator.arb.segments.manual.execute.set_with_opc() \n
		No command help available \n
		...
		self._core.io.write_with_opc(f'TRIGger:GPRF:GENerator<Instance>:ARB:SEGMents:MANual:EXECute', opc_timeout_ms)
