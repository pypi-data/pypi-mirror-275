...
class AllCls:
	...
	def fetch(self, timeout: float = None, target_main_state: enums.TargetStateA = None, target_sync_state: enums.TargetSyncState = None) -> List[enums.ResourceState]:
		...
		Snippet: value: List[enums.ResourceState] = driver.gprf.measurement.nrpm.state.all.fetch(timeout = 1.0, target_main_state = enums.TargetStateA.OFF, target_sync_state = enums.TargetSyncState.ADJusted) \n
