...
class IcomponentCls:
	...
	def read(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.gprf.measurement.fftSpecAn.icomponent.read() \n
		Returns the measured normalized I and Q amplitudes in the time domain. \n
		Suppressed linked return values: reliability \n
			:return: idata: Comma-separated list of N normalized I or Q amplitudes. N equals the configured FFT length."""
	...
	def fetch(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.gprf.measurement.fftSpecAn.icomponent.fetch() \n
		Returns the measured normalized I and Q amplitudes in the time domain. \n
		Suppressed linked return values: reliability \n
			:return: idata: Comma-separated list of N normalized I or Q amplitudes. N equals the configured FFT length."""
		suppressed = ArgSingleSuppressed(0, DataType.Integer, False, 1, 'Reliability')
