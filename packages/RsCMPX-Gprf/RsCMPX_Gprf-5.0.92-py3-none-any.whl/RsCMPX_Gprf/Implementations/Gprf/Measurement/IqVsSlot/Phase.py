...
class PhaseCls:
	...
	def read(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.gprf.measurement.iqVsSlot.phase.read() \n
		Returns the contents of the phase result diagram. \n
		Suppressed linked return values: reliability \n
			:return: phase: Comma-separated list of phases, one value per measured step"""
	...
	def fetch(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.gprf.measurement.iqVsSlot.phase.fetch() \n
		Returns the contents of the phase result diagram. \n
		Suppressed linked return values: reliability \n
			:return: phase: Comma-separated list of phases, one value per measured step"""
		suppressed = ArgSingleSuppressed(0, DataType.Integer, False, 1, 'Reliability')
