...
class SstopCls:
	...
	def set(self, start_index: int, stop_index: int) -> None:
		...
		Snippet: driver.configure.gprf.measurement.iqRecorder.listPy.sstop.set(start_index = 1, stop_index = 1) \n
	...
	def get(self) -> SstopStruct:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:IQRecorder:LIST:SSTop \n
		Snippet: value: SstopStruct = driver.configure.gprf.measurement.iqRecorder.listPy.sstop.get() \n
		No command help available \n
