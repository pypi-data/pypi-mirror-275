...
class Command(BaseCommand):
    ...
    BASE_PATH = Path("django_django_cefran/static/cefran/dist")

    def handle(self, *args, **options):
        files = [
            {
                "path": "django_cefran/cefran.module.min.js",
                "constant": "INTEGRITY_JS_MODULE",
            },
            {
                "path": "django_cefran/cefran.nomodule.min.js",
                "constant": "INTEGRITY_JS_NOMODULE",
            },
            {"path": "django_cefran/cefran.min.css", "constant": "INTEGRITY_CSS"},
...
# python manage.py integrity_checksums\n\n"""
        ...
        with open("django_cefran/checksums.py", "w") as output_file:
