...
from cefran.models import DjangoCefranConfig, CefranSocialMedia
    ...
    def handle(self, *args, **options):
        ...
        config, _created = DjangoCefranConfig.objects.get_or_create(
            ...
            defaults={
                ...
                "footer_description": '<a href="https://github.com/numerique-gouv/django-cefran" \r\ntarget="_blank" rel="noreferrer noopener">Dépôt Github</a>',
                "mourning": False,
                ...
                "newsletter_url": "https://github.com/numerique-gouv/django_cefran/releases",
            },
        )
