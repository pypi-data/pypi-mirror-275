...
from django_cefran.utils import cefran_input_class_attr

from django_cefran.constants import COLOR_CHOICES_ILLUSTRATION



class CefranDjangoTemplates(DjangoTemplates):
    @cached_property
    def engine(self):
        return self.backend(
            {
...
class CefranBaseForm(Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for visible in self.visible_fields():
            cefran_input_class_attr(visible)
    ...
    def default_renderer(self):
        ...
        return (
            CefranDjangoTemplates  # Settings wasn't modified
