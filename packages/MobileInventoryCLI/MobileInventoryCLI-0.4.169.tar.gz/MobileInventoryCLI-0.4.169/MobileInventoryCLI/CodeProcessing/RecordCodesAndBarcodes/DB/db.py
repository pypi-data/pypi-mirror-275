                    ...
                    try:
                        ...
                        def mkSelection(text,data):
                            try:
                               ...
                               return
                        edit_which=Prompt.__init2__(None,func=mkSelection,ptext=f"{Fore.dark_goldenrod}Edit Which result {Style.reset}{Fore.red}[num]{Style.reset}/{Fore.yellow}q|quit/b|back({Fore.cyan}Total Results={ct} & Default Entry=0){Style.reset}: ",helpText='',data=self)
                        #edit_which=input(f"{Fore.dark_goldenrod}Edit Which result {Style.reset}{Fore.red}[num]{Style.reset}/{Fore.yellow}q|quit/b|back({Fore.cyan}Total Results={ct} & Default Entry=0){Style.reset}: ")
