                        ...
                        if str(f) == 'Price':
                            def lclf(text,data):
                                try:
                                    ...
                                    return float(0)
                            dtmp=Prompt.__init2__(None,func=lclf,ptext=f"Entry {f}",helpText="Enter a value for {f}, or leave blank to use scanned code; e to skip entry altogether! p for previous",data=self)
                            ...
                            def lcli(text,data):
                                try:
                                    ...
                                    return int(1)
                            dtmp=Prompt.__init2__(None,func=lcli,ptext=f"Entry {f}",helpText="Enter a value for {f}, or leave blank to use scanned code; e to skip entry altogether! p for previous",data=self)
                        else:
                            def lclt(text,data):
                                return text
                            dtmp=Prompt.__init2__(None,func=lclt,ptext=f"Entry {f}",helpText="Enter a value for {f}, or leave blank to use scanned code; e to skip entry altogether! p for previous",data=self)
