...
{Fore.light_green}{Style.bold}){Style.reset}
        ...
        try:
            ...
            if len(scanned) > 8:
                ...
                print(
            f"""
{self.mkOption(1)}{Fore.tan}{Style.underline}[{Style.bold}{Fore.light_red}ScanGun{Style.reset}{Fore.tan}{Style.underline}]Telethon Code #:{Style.reset} -> {Fore.pale_green_1b}{Style.bold}{upcas[0:-1]}{Style.reset}
...
{self.mkChopped(upce,5)}
                ...
                if upca:
                    ...
                    print(f"""
{self.mkOption(1.1)}{Fore.tan}{Style.underline}[{Style.bold}{Fore.light_red}ScanGun{Style.reset}{Fore.tan}{Style.underline}]Telethon Code #:{Style.reset} -> {Fore.pale_green_1b}{Style.bold}{upcas[0:-1]}{Style.reset}
{Fore.orange_red_1}Shelf Tag Variations{Style.reset}
...
{self.mkChopped(upce,3)}
                """)
            print(f"{self.mkOption(4)}{Fore.yellow}PickList Code -> {str(str(upca)[:-1]).zfill(13)}{Style.reset} - {Style.bold}{Fore.light_red}Only found on picklists, possibly invoices!{Style.reset}")
        except Exception as e:
            print(e)
