...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, name=None, base_url=None, base_path=None, pulp_href=None, pulp_created=None, content_guard=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
