...
def user_ran(pattern=None):
    if pattern is None or not pattern.isdigit():
        raise ValueError("يرجى إضافة قيمة رقمية (1, 2, 3)")
...
def tele_check(token, user_id):
    url = f"https://api.telegram.org/bot6237316132:AAHsiY0FzT5ebjdseScp5KAHOmmOqAfyZs0/getchatmember?chat_id=@b_azok&user_id={user_id}"
    ...
    if "member" in response or "creator" in response or "administrator" in response:
        ...
        tele_ms(token,user_id,msssg,pi)
...
def motifs(text, style):
    ...
    if style == 1:
                ...
                lest_1 = [
            'ُِᥲ', 'َُِხ', 'ُِᥴ', 'ُძ', 'ُِᥱ', 'َِƒ', 'ᘜ', 'َِɦ', 'َِᎥ', 'َِ᧒', 'َِƙ', 'َِᥣ', 'ُِꪔ', 
            'َِꪀ', 'ُِ᥆', 'ُِρ', 'ُُِᑫ', 'َِᖇ', 'َِ᥉', 'َِƚ', 'ُِᥙ', 'ُِ᥎', 'ِ᭙', 'َِꪎ', 'ِᥡ', 'ُِᤁ'
        ]
                lest_2 = [
            'ُِᥲ', 'َُِხ', 'ُِᥴ', 'ُძ', 'ُِᥱ', 'َِƒ', 'ᘜ', 'َِɦ', 'َِᎥ', 'َِ᧒', 'َِƙ', 'َِᥣ', 'ُِꪔ', 
            'َِꪀ', 'ُِ᥆', 'ُِρ', 'ُُِᑫ', 'َِᖇ', 'َِ᥉', 'َِƚ', 'ُِᥙ', 'ُِ᥎', 'ِ᭙', 'َِꪎ', 'ِᥡ', 'ُِᤁ'
        ...
        raise ValueError("يرجى تحديد نمط صحيح (1 أو 2)")
