...
# required_packages = ['PyQt5', 'mysql-connector-python']
...
#
# import mysql.connector
# from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QLineEdit, QLabel, QWidget, QMessageBox
...
#         subprocess.Popen([sys.executable, "admin1.py"])
#         self.user.close()
#
