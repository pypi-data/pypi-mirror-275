...
class PutStreamByIdIdBody:
    ...
    Attributes:
        ...
        waste_code_id (Union[Unset, Any]):  Example: any.
    """
    ...
    waste_code_id: Union[Unset, Any] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        waste_code_id = self.waste_code_id
        ...
        if waste_code_id is not UNSET:
            field_dict["wasteCodeId"] = waste_code_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        waste_code_id = d.pop("wasteCodeId", UNSET)
