...
def map_interactive_multiplot(n_cols, geojson, locations, z_dict, subtitles, featureidkey, colorscale, marker_opacity, marker_line_width, mapbox_zoom,
                              ...
                              margin_l=50, margin_r=40, margin_t=60, margin_b=50, hspace=0.1, wspace=0.1, subtitles_height=0.90, hue_height=0.8):
        ...
        fig.update_layout(
            **{coloraxis_name: dict(
                ...
                colorbar=dict(
                    ...
                    y=hue_height - i*0.22,  # Center color bar vertically
