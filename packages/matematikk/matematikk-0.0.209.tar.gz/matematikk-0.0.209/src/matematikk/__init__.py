...
from ._exports.def_normalfordeling_standard_mas import (
    ...
    sannsynlighet_X_fra_mu_st,
    sannsynlighet_k_fra_mu_st,
    sannsynlighet_gunstig_fra_mu_st,

    # Alias > 1 > sannsynlighet_x_mindre_enn_fra_mu_st
    sannsynlighet_x_storre_enn_fra_mu_st,

    # Alias > 1 > sannsynlighet_gjennomsnitt_x_fra_mu_st
    sannsynlighet_gjennomsnitt_x_mindre_fra_mu_st,
    )
