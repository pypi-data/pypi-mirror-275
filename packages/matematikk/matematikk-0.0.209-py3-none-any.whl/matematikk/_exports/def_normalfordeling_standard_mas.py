...
def sannsynlighet_gjennomsnitt_x_fra_mu_st(
    mu                  = float(),
    st                  = float(),
    x                   = float(),
    x_enhet             = str(),
    ...
    for _ in range(sim):
        ...
        for _ in range(x_gjennomsnitt_ant):
            _rand = mt.random.normal(mu, st) # np.random.normal(mu, st) kan også brukes med import numpy as np
...
##########################################
# sannsynlighet_gjennomsnitt_x_fra_mu_st()
##########################################

# Alias > 1 > sannsynlighet_x_mindre_enn_fra_mu_st > ...
sannsynlighet_gjennomsnitt_x_mindre_fra_mu_st = sannsynlighet_gjennomsnitt_x_fra_mu_st
