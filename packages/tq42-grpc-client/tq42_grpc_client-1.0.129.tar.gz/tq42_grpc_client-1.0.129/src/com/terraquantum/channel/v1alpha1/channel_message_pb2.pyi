...
class ChannelMessage(_message.Message):
    ...
    ask_data: Ask
    tell_data: Tell
    def __init__(self, timestamp: _Optional[int] = ..., sequential_message_id: _Optional[int] = ..., acknowledge_data: _Optional[_Union[DataAcknowledge, _Mapping]] = ..., ask_data: _Optional[_Union[Ask, _Mapping]] = ..., tell_data: _Optional[_Union[Tell, _Mapping]] = ...) -> None: ...
