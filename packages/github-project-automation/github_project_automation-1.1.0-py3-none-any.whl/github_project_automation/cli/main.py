...
import click
from github_project_automation.common.constants import (
...
from github_project_automation.management.event_manager import EventManager
from github_project_automation.management.project_manager import ProjectManager
...
@click.option(
    '-v', '--version', help='Get the github-project-automation version.',
    is_flag=True, default=False, show_default=True
)
def main(version):
    if version:
        version = get_distribution('github-project-automation').version
        print(f'github-project-automation {version}')
