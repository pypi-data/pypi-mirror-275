from .codes import print_react_form, print_react_timetable, print_react_func, print_react_sp, print_react_routes, print_react_es5_es6, print_form_validation, print_bootstrap_table, print_routing , print_routingserver, print_es5vses6 , print_funclass , print_mongo , print_formval
...
def show():
    functions = {
        ...
        "formval" : "form validation using normal html and script"
    }
