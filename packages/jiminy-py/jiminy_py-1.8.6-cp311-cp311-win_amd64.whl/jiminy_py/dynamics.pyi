...
class State:
    ...
    def __init__(self, t, q, v=..., a=..., u=..., command=..., f_external=...) -> None: ...
...
def update_quantities(robot: jiminy.Model, position: np.ndarray, velocity: np.ndarray | None = None, acceleration: np.ndarray | None = None, update_physics: bool = True, update_centroidal: bool = True, update_energy: bool = True, update_jacobian: bool = False, update_collisions: bool = True, use_theoretical_model: bool = True) -> None: ...
