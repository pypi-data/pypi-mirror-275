...
class BlockEntityCompServer(BaseComponent):
    ...
    def SetSignTextStyle(self, pos, dimensionId, color, lighting):
        # type: (Tuple[int,int,int], int, Tuple[float,float,float,float], bool) -> bool
        """
        设置告示牌的文本样式
        """
        pass

    def GetSignTextStyle(self, pos, dimensionId):
        # type: (Tuple[int,int,int], int) -> dict
        """
        获取告示牌的文本样式信息
        """
