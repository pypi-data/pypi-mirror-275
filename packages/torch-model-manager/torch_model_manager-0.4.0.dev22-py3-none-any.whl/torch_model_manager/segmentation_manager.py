...
class SegmentationManager:
    ...
    def create_annotation_matrix(self, dataset_path, classes, box_threshold, text_threshold, nms_threshold, agg=hmean):
        ...
        return annotation_matrix, detections
    ...
    def occ_proba_disjoint_tensor(self, matrix: pd.DataFrame = None, apply_on_annotation_matrix = True, **kwargs):
        ...
        if apply_on_annotation_matrix:
            ...
            matrix, detections = self.create_annotation_matrix(dataset_path=dataset_path, 
                                                   classes=classes, 
                                                   box_threshold=box_threshold, 
                                                   text_threshold=text_threshold,
        ...
        return {"adjacency_tensor" : tensor, "index": matrix.index, "columns": classes, "detections": detections, "annotation_matrix": matrix}
